...
(self['webpackChunkpkm_start'] = self['webpackChunkpkm_start'] || []).push([
    [96],
    {
        /***/ 44: /***/ (
            ...
            /* unused harmony exports a, g, k, o */
            ...
            function animateCSSModeScroll({ swiper, targetPosition, side }) {
                ...
                const animate = () => {
                    ...
                    let currentPosition =
                        startPosition +
                        easeProgress * (targetPosition - startPosition);
            ...
            function getSlideTransformEl(slideEl) {
                return (
                    ...
                    (slideEl.shadowRoot &&
                        slideEl.shadowRoot.querySelector(
        ...
        /***/ 150: /***/ (
            ...
            var utils = __webpack_require__(44); // ./node_modules/swiper/modules/virtual.mjs
            function Virtual({ swiper, extendParams, on, emit }) {
                ...
                function update(force, beforeInit, forceActiveIndex) {
                    ...
                    if (slidesPerView === 'auto') {
                        if (slidesPerViewAutoSlideSize) {
                            ...
                            slidesPerViewNumeric = Math.max(
                                1,
                                Math.ceil(
                                    swiperSize / slidesPerViewAutoSlideSize
                                )
                            );
                        } else {
                    ...
                    if (centeredSlides) {
                        slidesAfter =
                            Math.floor(slidesPerViewNumeric / 2) +
                            slidesPerGroup +
                            addSlidesAfter;
                        slidesBefore =
                            Math.floor(slidesPerViewNumeric / 2) +
                        ...
                        slidesAfter =
                            slidesPerViewNumeric +
                            (slidesPerGroup - 1) +
                            addSlidesAfter;
                        slidesBefore =
                            (isLoop ? slidesPerViewNumeric : slidesPerGroup) +
                            addSlidesBefore;
                    }
                    ...
                    appendIndexes.forEach((index) => {
                        swiper.slidesEl.append(
                            renderSlide(slides[index], index)
                        );
                    });
                    if (isLoop) {
                        for (
                            let i = prependIndexes.length - 1;
                            i >= 0;
                            i -= 1
                        ) {
                            const index = prependIndexes[i];
                            swiper.slidesEl.prepend(
                                renderSlide(slides[index], index)
                            );
                        }
                    } else {
                    ...
                    if (Array.isArray(slidesIndexes)) {
                        for (let i = slidesIndexes.length - 1; i >= 0; i -= 1) {
                            if (swiper.params.virtual.cache) {
                                ...
                                // shift cache indexes
                                Object.keys(swiper.virtual.cache).forEach(
                                    (key) => {
                ...
                on('beforeInit', () => {
                    ...
                    if (
                        typeof swiper.passedParams.virtual.slides ===
                        'undefined'
                    ) {
                        const slides = [...swiper.slidesEl.children].filter(
                            (el) =>
                                el.matches(
                                    `.${swiper.params.slideClass}, swiper-slide`
                                )
            ...
            function Keyboard({ swiper, extendParams, on, emit }) {
                ...
                function handle(event) {
                    ...
                    if (
                        ...
                        const swiperOffset = (0, utils.f)(el);
            ...
            function Navigation({ swiper, extendParams, on, emit }) {
                ...
                function update() {
                    ...
                    toggleEl(
                        prevEl,
                        swiper.isBeginning && !swiper.params.rewind
                    );
                    ...
                    if (swiper.isElement && !targetIsButton) {
                        ...
                        if (path) {
                            targetIsButton = path.find(
                                (pathEl) =>
                                    nextEl.includes(pathEl) ||
                                    prevEl.includes(pathEl)
                            );
                        }
                    }
                    if (
            ...
            function Pagination({ swiper, extendParams, on, emit }) {
                ...
                function onBulletClick(e) {
                    ...
                    e.preventDefault();
                    const index =
                        (0, utils.j)(bulletEl) * swiper.params.slidesPerGroup;
                    if (swiper.params.loop) {
                    ...
                    if (
                        ...
                        bullets.forEach((bulletEl) => {
                            const classesToRemove = [
                                ...[
                                    ...
                                    (suffix) =>
                                        `${params.bulletActiveClass}${suffix}`
                                ),
                            ]
                                .map((s) =>
                        ...
                        if (el.length > 1) {
                            bullets.forEach((bullet) => {
                                const bulletIndex = (0, utils.j)(bullet);
                ...
                function render() {
                    ...
                    const slidesLength =
                        swiper.virtual && swiper.params.virtual.enabled
                            ...
                            : swiper.grid && swiper.params.grid.rows > 1
                              ? swiper.slides.length /
                                Math.ceil(swiper.params.grid.rows)
                              : swiper.slides.length;
                    let el = swiper.pagination.el;
                    el = (0, utils.m)(el);
                    let paginationHTML = '';
                    if (params.type === 'bullets') {
                        let numberOfBullets = swiper.params.loop
                            ? Math.ceil(
                                  slidesLength / swiper.params.slidesPerGroup
                              )
                            : swiper.snapGrid.length;
                        if (
                            swiper.params.freeMode &&
                ...
                function init() {
                    ...
                    el.forEach((subEl) => {
                        ...
                        if (
                            ...
                            subEl.classList.add(
                                params.progressbarOppositeClass
                            );
                        }
                        if (params.clickable) {
            ...
            function Parallax({ swiper, extendParams, on }) {
                ...
                const setTransform = (el, progress) => {
                    ...
                    const opacity = el.getAttribute(
                        'data-swiper-parallax-opacity'
                    );
                    const rotate = el.getAttribute(
                        'data-swiper-parallax-rotate'
                    );
                    if (x || y) {
                        x = x || '0';
                        y = y || '0';
                ...
                const setTranslate = () => {
                    const { el, slides, progress, snapGrid, isElement } =
                        swiper;
                ...
                const setTransition = (duration = swiper.params.speed) => {
                    ...
                    if (swiper.isElement) {
                        elements.push(
                            ...hostEl.querySelectorAll(elementsSelector)
                        );
                    }
            ...
            function Zoom({ swiper, extendParams, on, emit }) {
                ...
                function onTouchMove(e) {
                    ...
                    if (!image.isMoved) {
                        image.width =
                            gesture.imageEl.offsetWidth ||
                            gesture.imageEl.clientWidth;
                        image.height =
                            gesture.imageEl.offsetHeight ||
                            gesture.imageEl.clientHeight;
                        image.startX =
                            getTranslate(gesture.imageWrapEl, 'x') || 0;
                        image.startY =
                            getTranslate(gesture.imageWrapEl, 'y') || 0;
                    ...
                    if (image.currentX < image.minX) {
                        image.currentX =
                            image.minX +
                            1 -
                            (image.minX - image.currentX + 1) ** 0.8;
                    }
                    if (image.currentX > image.maxX) {
                        image.currentX =
                            image.maxX -
                            1 +
                            (image.currentX - image.maxX + 1) ** 0.8;
                    }
                    if (image.currentY < image.minY) {
                        image.currentY =
                            image.minY +
                            1 -
                            (image.minY - image.currentY + 1) ** 0.8;
                    }
                    if (image.currentY > image.maxY) {
                        image.currentY =
                            image.maxY -
                            1 +
                            (image.currentY - image.maxY + 1) ** 0.8;
                    }
                ...
                function onTransitionEnd() {
                    ...
                    if (
                        gesture.slideEl &&
                        swiper.activeIndex !==
                            swiper.slides.indexOf(gesture.slideEl)
                    ) {
                        if (gesture.imageEl) {
                        ...
                        if (gesture.imageWrapEl) {
                            gesture.imageWrapEl.style.transform =
                                'translate3d(0,0,0)';
                        }
                        gesture.slideEl.classList.remove(
                ...
                function onMouseMove(e) {
                    ...
                    const deltaX =
                        (e.clientX - mousePanStart.x) * mousePanSensitivity;
                    const deltaY =
                        (e.clientY - mousePanStart.y) * mousePanSensitivity;
                    ...
                    const maxY = -minY;
                    const newX = Math.max(
                        Math.min(image.startX + deltaX, maxX),
                        minX
                    );
                    const newY = Math.max(
                        Math.min(image.startY + deltaY, maxY),
                        minY
                    );
                    gesture.imageWrapEl.style.transitionDuration = '0ms';
                ...
                function zoomIn(e) {
                    ...
                    if (e && !(currentScale === 1 && forceZoomRatio)) {
                        ...
                        offsetX =
                            elementOffset(gesture.slideEl).left +
                            window.scrollX;
                        offsetY =
                            elementOffset(gesture.slideEl).top + window.scrollY;
                        ...
                        if (
                            ...
                            translateX =
                                (image.currentX * zoom.scale) / prevScale;
                            translateY =
                                (image.currentY * zoom.scale) / prevScale;
                        } else {
                ...
                function getListeners() {
                    const passiveListener = swiper.params.passiveListeners
                        ...
                        : false;
                    const activeListenerWithCapture = swiper.params
                        .passiveListeners
                        ? {
                              passive: false,
                              capture: true,
                ...
                on('beforeInit', () => {
                    if (
                        ...
                        (typeof swiper.params.controller.control === 'string' ||
                            swiper.params.controller.control instanceof
                                HTMLElement)
                    ) {
                        ...
                        controlElements.forEach((controlElement) => {
                            ...
                            if (controlElement && controlElement.swiper) {
                                swiper.controller.control.push(
                                    controlElement.swiper
                                );
            ...
            function A11y({ swiper, extendParams, on }) {
                ...
                function onEnterOrSpaceKey(e) {
                    ...
                    if (
                        ...
                        const prevEls = makeElementsArray(
                            swiper.navigation.prevEl
                        );
                        const nextEls = makeElementsArray(
                            swiper.navigation.nextEl
                        );
                ...
                function hasClickablePagination() {
                    return (
                        hasPagination() && swiper.params.pagination.clickable
                    );
                }
                ...
                const init = () => {
                    ...
                    if (hasClickablePagination()) {
                        const paginationEl = makeElementsArray(
                            swiper.pagination.el
                        );
            ...
            function HashNavigation({ swiper, extendParams, emit, on }) {
                        ...
                        getSlideIndex(_s, hash) {
                            if (
                                ...
                                const slideWithHash = swiper.slides.find(
                                    (slideEl) =>
                                        slideEl.getAttribute('data-hash') ===
                                        hash
                                );
                ...
                const onHashChange = () => {
                    ...
                    if (newHash !== activeSlideHash) {
                        const newIndex =
                            swiper.params.hashNavigation.getSlideIndex(
                                swiper,
                                newHash
                            );
                        if (
            ...
            function Thumb({ swiper, extendParams, on }) {
                ...
                function init() {
                    ...
                    } else if ((0, utils.p)(thumbsParams.swiper)) {
                    ...
                    if (
                        ...
                        for (let i = 0; i < thumbsToActivate; i += 1) {
                            if (thumbsSwiper.slides[swiper.realIndex + i]) {
                                thumbsSwiper.slides[
                                    swiper.realIndex + i
                                ].classList.add(thumbActiveClass);
                            }
                        }
                    }
                ...
                function onTouchEnd({ currentPos }) {
                    ...
                    if (params.freeMode.momentum) {
                        if (data.velocities.length > 1) {
                            ...
                            const time =
                                lastMoveEvent.time - velocityEvent.time;
                        ...
                        swiper.velocity *=
                            params.freeMode.momentumVelocityRatio;
                        data.velocities.length = 0;
                        let momentumDuration =
                            1000 * params.freeMode.momentumRatio;
            ...
            function EffectCube({ swiper, extendParams, on }) {
                ...
                const setTransition = (duration) => {
                    ...
                    if (
                        ...
                        const shadowEl = el.querySelector(
                            '.swiper-cube-shadow'
                        );
                        if (shadowEl)
            ...
            function EffectCoverflow({ swiper, extendParams, on }) {
                ...
                const setTranslate = () => {
                    ...
                    for (
                        ...
                        let rotateY = isHorizontal
                            ? rotate * offsetMultiplier
                            : 0;
                        let rotateX = isHorizontal
                            ? 0
                            : rotate * offsetMultiplier;
                        // var rotateZ = 0
                        let translateZ =
                        ...
                        let translateX = isHorizontal
                            ...
                            : 0;
                        let scale =
                            1 - (1 - params.scale) * Math.abs(offsetMultiplier);
            ...
            function EffectCreative({ swiper, extendParams, on }) {
                ...
                const setTranslate = () => {
                    ...
                    for (let i = 0; i < slides.length; i += 1) {
                        ...
                        slideEl.style.zIndex =
                            -Math.abs(Math.round(slideProgress)) +
                            slides.length;
            ...
            function EffectCards({ swiper, extendParams, on }) {
                ...
                const setTranslate = () => {
                    ...
                    const { startTranslate, isTouched } =
                        swiper.touchEventsData;
                    const currentTranslate = rtl
                        ? -swiper.translate
                        : swiper.translate;
                    for (let i = 0; i < slides.length; i += 1) {
                        const slideEl = slides[i];
                        ...
                        let tXAdd =
                            params.perSlideOffset - Math.abs(progress) * 0.75;
                        const slideIndex =
                            swiper.virtual && swiper.params.virtual.enabled
      ...
      `;
                ...
                effectInit({
                    ...
                    overwriteParams: () => ({
                        ...
                        watchSlidesProgress: true,
                        loopAdditionalSlides: swiper.params.cardsEffect.rotate
                            ? 3
                            : 2,
                        centeredSlides: true,
                        virtualTranslate: !swiper.params.cssMode,
        ...
        /***/ 236: /***/ (
            ...
            var ssr_window_esm = __webpack_require__(375);
            // EXTERNAL MODULE: ./node_modules/swiper/shared/utils.mjs
            var utils = __webpack_require__(44); // ./node_modules/swiper/shared/swiper-core.mjs
            let support;
            ...
            function Observer({ swiper, extendParams, on, emit }) {
                ...
                const init = () => {
                    ...
                    if (swiper.params.observeParents) {
                        const containerParents = (0, utils.d)(swiper.hostEl);
            ...
            function updateSize() {
                ...
                width =
                    width -
                    parseInt((0, utils.q)(el, 'padding-left') || 0, 10) -
                    parseInt((0, utils.q)(el, 'padding-right') || 0, 10);
                height =
                    height -
                    parseInt((0, utils.q)(el, 'padding-top') || 0, 10) -
                    parseInt((0, utils.q)(el, 'padding-bottom') || 0, 10);
            ...
            function updateSlides() {
                ...
                function getDirectionPropertyValue(node, label) {
                    return parseFloat(
                        node.getPropertyValue(
                            swiper.getDirectionLabel(label)
                        ) || 0
                    );
                }
                ...
                const shouldResetSlideSize =
                    ...
                    Object.keys(params.breakpoints).filter((key) => {
                        return (
                            typeof params.breakpoints[key].slidesPerView !==
                            'undefined'
                        );
                    }).length > 0;
                for (let i = 0; i < slidesLength; i += 1) {
                    ...
                    if (isVirtual && params.slidesPerView === 'auto') {
                        if (params.virtual.slidesPerViewAutoSlideSize) {
                            slideSize =
                                params.virtual.slidesPerViewAutoSlideSize;
                        }
                        if (slideSize && slide) {
                        ...
                        if (params.roundLengths) {
                            slideSize = swiper.isHorizontal()
                                ? (0, utils.i)(slide, 'width', true)
                                : (0, utils.i)(slide, 'height', true);
                        } else {
                            // eslint-disable-next-line
                ...
                if (isVirtual && params.loop) {
                    ...
                    if (params.slidesPerGroup > 1) {
                        const groups = Math.ceil(
                            (swiper.virtual.slidesBefore +
                                swiper.virtual.slidesAfter) /
                                params.slidesPerGroup
                        );
                        const groupSize = size * params.slidesPerGroup;
                        for (let i = 0; i < groups; i += 1) {
                            snapGrid.push(
                                snapGrid[snapGrid.length - 1] + groupSize
                            );
                        }
                    }
                    for (
                        ...
                        slidesGrid.push(
                            slidesGrid[slidesGrid.length - 1] + size
                        );
                ...
                if (
                    ...
                    swiper.snapGrid = swiper.snapGrid.map(
                        (v) => v + addToSnapGrid
                    );
            ...
            const toggleSlideClasses$1 = (slideEl, condition, className) => {
                if (condition && !slideEl.classList.contains(className)) {
                    ...
                    !condition &&
                    slideEl.classList.contains(className)
                ) {
            ...
            function updateProgress(translate) {
                ...
                if (params.loop) {
                    ...
                    const firstSlideTranslate =
                        swiper.slidesGrid[firstSlideIndex];
                    const lastSlideTranslate =
            ...
            function updateSlidesClasses() {
                ...
                if (isVirtual) {
                    if (params.loop) {
                        let slideIndex =
                            activeIndex - swiper.virtual.slidesBefore;
                        if (slideIndex < 0)
                            slideIndex =
                ...
                if (swiper.params.rewind || swiper.params.loop) {
                    for (
                        ...
                        if (
                            ...
                            realIndex > slideIndexLastInView
                        )
            ...
            function updateActiveIndex(newActiveIndex) {
                ...
                if (swiper.virtual && params.virtual.enabled && params.loop) {
                    ...
                    let activeSlideIndex = parseInt(
                        firstSlideInColumn.getAttribute(
                            'data-swiper-slide-index'
                        ),
                        10
                    );
            ...
            function getSwiperTranslate(
                ...
                let currentTranslate = (0, utils.l)(wrapperEl, axis);
            ...
            function slideTo(
                ...
                if (params.normalizeSlideIndex) {
                    for (let i = 0; i < slidesGrid.length; i += 1) {
                        const normalizedTranslate = -Math.floor(
                            translate * 100
                        );
                        const normalizedGrid = Math.floor(slidesGrid[i] * 100);
                        const normalizedGridNext = Math.floor(
                            slidesGrid[i + 1] * 100
                        );
                        if (typeof slidesGrid[i + 1] !== 'undefined') {
                            if (
                                ...
                                normalizedTranslate <
                                    normalizedGridNext -
                                        (normalizedGridNext - normalizedGrid) /
                                            2
                            ) {
                                slideIndex = i;
                            } else if (
            ...
            function slideToLoop(
                ...
                if (swiper.params.loop) {
                    if (swiper.virtual && swiper.params.virtual.enabled) {
                        ...
                        if (gridEnabled) {
                            const slideIndex =
                                newIndex * swiper.params.grid.rows;
                            ...
                            targetSlideIndex =
                                swiper.getSlideIndexByData(newIndex);
                        }
                        ...
                        let needLoopFix =
                            cols - targetSlideIndex < slidesPerView;
                        if (bothDirections) {
                            needLoopFix =
                                needLoopFix ||
            ...
            function slidePrev(speed, runCallbacks = true, internal) {
                ...
                const normalizedSnapGrid = snapGrid.map((val) =>
                    normalize(val)
                );
            ...
            function slideToClosest(
                ...
                if (translate >= swiper.snapGrid[snapIndex]) {
                    ...
                    if (
                        translate - prevSnap <=
                        (currentSnap - prevSnap) * threshold
                    ) {
                        index -= swiper.params.slidesPerGroup;
                    }
                }
            ...
            function slideToClickedSlide() {
                ...
                const slidesPerView =
                    params.slidesPerView === 'auto'
                        ? swiper.slidesPerViewDynamic()
                        : params.slidesPerView;
                let slideToIndex = swiper.getSlideIndexWhenGrid(
                    swiper.clickedIndex
                );
                let realIndex;
                ...
                if (params.loop) {
                    ...
                    realIndex = parseInt(
                        swiper.clickedSlide.getAttribute(
                            'data-swiper-slide-index'
                        ),
                        10
                    );
            ...
            function loopCreate(slideRealIndex, initial) {
                ...
                const slidesPerGroup =
                    params.slidesPerGroup *
                    (gridEnabled ? params.grid.rows : 1);
                const shouldFillGroup =
                    swiper.slides.length % slidesPerGroup !== 0;
                const shouldFillGrid =
                    gridEnabled &&
                    swiper.slides.length % params.grid.rows !== 0;
                const addBlankSlides = (amountOfSlides) => {
                    for (let i = 0; i < amountOfSlides; i += 1) {
                        const slideEl = swiper.isElement
                            ? (0, utils.c)('swiper-slide', [
                                  params.slideBlankClass,
                              ])
                            : (0, utils.c)('div', [
                                  params.slideClass,
            ...
            function loopFix({
                ...
                if (slidesPerView === 'auto') {
                    ...
                    slidesPerView = Math.ceil(
                        parseFloat(params.slidesPerView, 10)
                    );
                    if (bothDirections && slidesPerView % 2 === 0) {
                        slidesPerView = slidesPerView + 1;
                    }
                ...
                if (loopedSlides % slidesPerGroup !== 0) {
                    loopedSlides +=
                        slidesPerGroup - (loopedSlides % slidesPerGroup);
                }
                ...
                const isInitialOverflow =
                    initial &&
                    cols - initialSlide < slidesPerView &&
                    !bothDirections;
                    ...
                    if (prependSlidesIndexes.length > 0 && isPrev) {
                        if (typeof slideRealIndex === 'undefined') {
                            ...
                            const newSlideTranslate =
                                swiper.slidesGrid[
                                    activeIndex + slidesPrepended
                                ];
                            const diff =
                                newSlideTranslate - currentSlideTranslate;
                            if (byMousewheel) {
                ...
                if (
                    ...
                    if (Array.isArray(swiper.controller.control)) {
                        ...
                        swiper.controller.control instanceof
                            swiper.constructor &&
                        ...
                        swiper.controller.control.loopFix({
                            ...loopParams,
                            slideTo:
                                swiper.controller.control.params
            ...
            function closestElement(selector, base = this) {
                function __closestFrom(el) {
                    if (
                        !el ||
                        el === (0, ssr_window_esm.g)() ||
                        el === (0, ssr_window_esm.a)()
                    )
                        return null;
            ...
            function onTouchMove(event) {
                ...
                const allowLoopFix =
                    (swiper.touchesDirection === 'next' &&
                        swiper.allowSlideNext) ||
                    (swiper.touchesDirection === 'prev' &&
                        swiper.allowSlidePrev);
                if (!data.isMoved) {
                        ...
                        data.currentTranslate >
                            (params.centeredSlides
                                ? swiper.minTranslate() -
                                  ...
                                  (params.slidesPerView !== 'auto' &&
                                  swiper.slides.length - params.slidesPerView >=
                                      2
                                      ? swiper.slidesSizesGrid[
                                            swiper.activeIndex + 1
                ...
                for (
                    ...
                    if (typeof slidesGrid[i + increment] !== 'undefined') {
                        if (
                            ...
                            stopIndex = i;
                            groupSize =
                                slidesGrid[i + increment] - slidesGrid[i];
                        }
    ...
    'watch-progress': params.watchSlidesProgress
            ...
            function moduleExtendParams(params, allModulesParams) {
                return function extendParams(obj = {}) {
                    ...
                    if (
                        ['pagination', 'scrollbar'].indexOf(moduleParamName) >=
                            0 &&
                        params[moduleParamName] &&
                        params[moduleParamName].enabled &&
      ...
      'marginRight': 'marginBottom'
                ...
                getSlideIndex(slideEl) {
                    ...
                    const firstSlideIndex = (0, utils.j)(slides[0]);
                    return (0, utils.j)(slideEl) - firstSlideIndex;
                }
                ...
                mount(element) {
                    ...
                    Object.assign(swiper, {
                        ...
                        rtl:
                            ...
                            (0, utils.q)(el, 'direction') === 'rtl',
                        rtlTranslate:
                            swiper.params.direction === 'horizontal' &&
                            (el.dir.toLowerCase() === 'rtl' ||
                                (0, utils.q)(el, 'direction') === 'rtl'),
                        wrongRTL:
                            (0, utils.q)(wrapperEl, 'display') ===
                            '-webkit-box',
                    });
                    return true;
                }
                init(el) {
                    ...
                    if (swiper.isElement) {
                        lazyElements.push(
                            ...swiper.hostEl.querySelectorAll(
                                '[loading="lazy"]'
                            )
                        );
                    }
            ...
            Swiper.use([Resize, Observer]); // ./node_modules/swiper/swiper.mjs
            /**
             * Swiper 12.0.3
        ...
        /***/ 364: /***/ (
            ...
            const isString_t = (t) => 'string' == typeof t; // ./node_modules/@fancyapps/ui/dist/utils/isNode.js

            /*! License details at fancyapps.com/license */
            const isNode_n = (n) =>
                n && null !== n && n instanceof Element && 'nodeType' in n; // ./node_modules/@fancyapps/ui/dist/utils/getScrollableParent.js
            ...
            const e = function (e) {
                    ...
                    if (e.scrollWidth > e.clientWidth) {
                        const i = window.getComputedStyle(e).overflowX,
                            t = -1 !== i.indexOf('hidden'),
                            o = -1 !== i.indexOf('clip'),
                            d = -1 !== i.indexOf('visible');
                        n = !t && !o && !d;
                    }
                    if (e.scrollHeight > e.clientHeight) {
                        const n = window.getComputedStyle(e).overflowY,
                            t = -1 !== n.indexOf('hidden'),
                            o = -1 !== n.indexOf('clip'),
                            d = -1 !== n.indexOf('visible');
                        i = !t && !o && !d;
                    }
                    return n || i;
                },
                getScrollableParent_n = function (i, t = void 0) {
                    return !i || i === document.body || (t && i === t)
                        ? null
                        : e(i)
                          ? i
                          : getScrollableParent_n(i.parentElement, t);
            ...
            const strToHtml_e = function (e) {
                ...
                let r = t.firstChild;
                return !r || r instanceof HTMLElement
                    ? r
                    : ((n = document.createElement('div')).appendChild(r), n);
            ...
            /*! License details at fancyapps.com/license */
            const isPlainObject_t = (t) =>
                'object' == typeof t &&
                null !== t &&
                t.constructor === Object &&
                '[object Object]' === Object.prototype.toString.call(t); // ./node_modules/@fancyapps/ui/dist/utils/isEqual.js
            ...
            const tween_e = function (n) {
                for (const t of s)
                    t.getState() === i.Running && t.tick(a ? n - a : 0);
            ...
            (!(function (n) {
                ...
                (function (n) {
                    ((n[(n.Loop = 0)] = 'Loop'),
                        (n[(n.Reverse = 1)] = 'Reverse'));
                })(r || (r = {})));
            const s = new Set();
            let u = null,
                a = 0;
            function tween_c() {
                let a = i.Initializing,
                    f = o.Ease,
                    l = 0,
                    g = 0,
                    p = tween_c.Easings.Linear,
                    m = 500,
                    d = 0,
                    b = 0,
                    S = 0,
                ...
                const F = {
                    ...
                    start: function (n) {
                        return (
                            isEqual_n(v, O) ||
                                ...
                                s.add(this),
                                u ||
                                    (u = window.requestAnimationFrame(tween_e)),
                                q(n)),
                            F
                        );
                    },
                    pause: function () {
                        return (
                            ...
                            a === i.Running && ((a = i.Paused), V('pause', v)),
                            F
                        );
                    },
                    end: A,
                ...
                const o = [],
                    s = gestures_e(t)
                        ...
                        : t instanceof MouseEvent &&
                            ('changedTouches' === n || 'mouseup' !== t.type)
                          ? [t]
                          : [];
                for (const e of s)
                    o.push({ x: e.clientX, y: e.clientY, ts: Date.now() });
                return o;
            }
            function n(e) {
                return t(e, 'touches');
            ...
            const f = (e, t) => {
                let f,
                    h,
                    v,
                    g = Object.assign(Object.assign({}, gestures_u), t),
                    p = [],
                    m = [],
                    E = [],
                    w = !1,
                ...
                const O = new Map();
                function S(e) {
                    const t = gestures_r(m),
                        n = gestures_r(E),
                        o = t && n ? t / n : 0,
                        s = Math.abs(Y) > Math.abs(j) ? Y : j,
                        i = {
                            srcEvent: f,
                            isPanRecognized: w,
                            isSwipeRecognized: y,
                ...
                function q(e) {
                    const t = e.target,
                        n = e.composedPath()[0],
                        o = g.ignore.join(','),
                        s = (e) => e && (e.matches(o) || e.closest(o));
                    if (s(t) || s(n)) return !1;
                }
                function C(e) {
                    const t = Date.now();
                    if (
                        ((R = R.filter((e) => !e.ts || e.ts > t - 100)),
                        e && R.push(e),
                        (Y = 0),
                        (j = 0),
                        R.length > 3)
                        ...
                        if (e && t) {
                            const n = t.x - e.x,
                                o = t.y - e.y,
                                s = e.ts && t.ts ? t.ts - e.ts : 0;
                            s > 0 &&
                                ((Y = Math.abs(n) > 3 ? n / (s / 30) : 0),
                                (j = Math.abs(o) > 3 ? o / (s / 30) : 0));
                        }
                    }
                }
                function I(e) {
                ...
                function B(e) {
                    ...
                    if (m.length > 1) {
                        const e = gestures_r(m),
                            t = gestures_r(E);
                        Math.abs(e - t) >= 0.1 && ((T = !0), S('pinch'));
                    }
                    (w ||
                        ((w =
                            Math.abs(D) > g.panThreshold ||
                            Math.abs(X) > g.panThreshold),
                        w &&
                            ((d = !1),
                            clearTimeout(A),
                            (A = 0),
                            (k = Math.abs((180 * Math.atan2(X, D)) / Math.PI)),
                            (v = k > 45 && k < 135 ? 'y' : 'x'),
                            (p = [...m]),
                            (E = [...m]),
                            (D = 0),
                ...
                function F(e) {
                    ...
                    const t = gestures_o(e),
                        n = gestures_s(e);
                    if (
                        ((x = t.length),
                        (h = gestures_i(n)),
                        n.length && C(gestures_i(n)),
                        (E = [...m]),
                        (m = [...t]),
                        (p = [...t]),
                        x > 0)
                ...
                function J(e) {
                    ...
                    ((l = !1),
                        t &&
                            !e.defaultPrevented &&
                            (d || (c(e), e.stopPropagation())));
                }
                const K = {
                    init: function () {
                        return (
                            e &&
                                (e.addEventListener('click', J, gestures_a),
                                e.addEventListener('mousedown', I, gestures_a),
                                e.addEventListener('touchstart', I, gestures_a),
                                e.addEventListener('touchmove', B, gestures_a),
                                e.addEventListener('touchend', F),
                                e.addEventListener('touchcancel', F)),
                            K
                        );
                    },
                    on: function (e, t) {
                    ...
                    destroy: function () {
                        (clearTimeout(z),
                            ...
                            (A = 0),
                            e &&
                                (e.removeEventListener('click', J, gestures_a),
                                ...
                                e.removeEventListener('touchcancel', F)),
                            (e = null),
                            H());
                    },
                };
            ...
            f.isClickAllowed = () => d; // ./node_modules/@fancyapps/ui/dist/panzoom/l10n/en_EN.js
            ...
            const h = (e) => {
                ...
                p = (e) => e instanceof HTMLImageElement;
            var v, b;
            (!(function (e) {
                ((e.Reset = 'reset'),
                    (e.Zoom = 'zoom'),
                    ...
                    (e.ZoomOut = 'zoomOut'),
                    (e.ZoomTo = 'zoomTo'),
                    (e.ToggleCover = 'toggleCover'),
                    (e.ToggleFull = 'toggleFull'),
                    (e.ToggleMax = 'toggleMax'),
                    (e.IterateZoom = 'iterateZoom'),
                    (e.Pan = 'pan'),
                    (e.Swipe = 'swipe'),
                    (e.Move = 'move'),
                    (e.MoveLeft = 'moveLeft'),
                    (e.MoveRight = 'moveRight'),
                    (e.MoveUp = 'moveUp'),
                    (e.MoveDown = 'moveDown'),
                    (e.RotateCCW = 'rotateCCW'),
                    (e.RotateCW = 'rotateCW'),
                    (e.FlipX = 'flipX'),
                    (e.FlipY = 'flipY'),
                    (e.ToggleFS = 'toggleFS'));
            ...
            const y = { x: 0, y: 0, scale: 1, angle: 0, flipX: 1, flipY: 1 },
                x = {
                    bounds: !0,
                    classes: {
                        container: 'f-panzoom',
            ...
            const E = (c, b = {}, E = {}) => {
                let S,
                    ...
                    L,
                    P = 0,
                    X = Object.assign(Object.assign({}, x), b),
                    Y = {},
                    R = Object.assign({}, y),
                    z = Object.assign({}, y);
                const D = [];
                ...
                function H(e, ...t) {
                    ...
                    X.on && n.push(X.on[e]);
                    for (const e of n)
                        e && e instanceof Function && e(je, ...t);
                    '*' !== e && H('*', e, ...t);
                }
                function $(e) {
                    if (!W()) return;
                ...
                function _(e) {
                    ...
                    if (
                        ...
                        i.hasAttribute('data-carousel-go-prev') ||
                        i.hasAttribute('data-carousel-go-next')
                    )
                        return;
                    const a = i.closest('[data-panzoom-action]'),
                        s =
                            null === (n = null == a ? void 0 : a.dataset) ||
                            void 0 === n
                                ? void 0
                                : n.panzoomAction,
                        r =
                            (null === (o = null == a ? void 0 : a.dataset) ||
                            void 0 === o
                                ? void 0
                                : o.panzoomValue) || '';
                    if (s) {
                        switch ((h(e), s)) {
                            ...
                            case v.ZoomIn:
                            case v.ZoomOut:
                                ue(s, { scale: parseFloat(r || '') || void 0 });
                                break;
                            case v.MoveLeft:
                            case v.MoveRight:
                                ue(s, {
                ...
                function B(e) {
                    ...
                    if (
                        (
                            (null == S ? void 0 : S.dataset.animationName) || ''
                        ).indexOf('zoom') > -1
                    )
                        return;
                    const t = ee(z.scale);
                    if (!t) return;
                    const { x: n, y: o } = t;
                    ue(v.Pan, { deltaX: n - z.x, deltaY: o - z.y });
                }
                function N() {
                    var e;
                    c &&
                        (removeClass_s(c, 'is-loading'),
                        null === (e = c.querySelector('.f-spinner')) ||
                            void 0 === e ||
                            e.remove());
                }
                function V() {
                    if (!c || !O) return;
                    if ((N(), p(O) && (!O.complete || !O.naturalWidth)))
                        return (
                            (P = 2),
                            null == S || S.classList.add('has-error'),
                            void H('error')
                        );
                    H('loaded');
                    ...
                    (p(O) &&
                        ...
                        S &&
                            (removeClass_s(S, 'has-error'),
                            p(O) &&
                                (S.setAttribute('width', e + ''),
                                S.setAttribute('height', t + ''),
                                (S.style.aspectRatio = `${e / t || ''}`))),
                        (F = tween_c()
                            .on('start', (e, t) => {
                                (void 0 !== t.angle &&
                            ...
                            .on('step', (e) => {
                                ...
                                let d = !1;
                                (((o && l) || (n && r)) &&
                                    ((z.x = clamp_t(t.x[0], z.x, t.x[1])),
                                    (d = !0)),
                                    ((a && c) || (s && u)) &&
                                        ((z.y = clamp_t(t.y[0], z.y, t.y[1])),
                                        (d = !0)),
                                    d &&
                                        F &&
                                        F.spring({
                            ...
                            .on('end', () => {
                                ((null == T ? void 0 : T.isPointerDown()) ||
                                    le(),
                                    (null == F ? void 0 : F.isRunning()) ||
                                        (ce(), H('animationEnd')));
                            })),
                        (function () {
                            const e = I('gestures');
                        ...
                        null == c || c.addEventListener('click', _),
                        null === document ||
                            void 0 === document ||
                            document.addEventListener('mousemove', B),
                        D.push(() => {
                            (null == c || c.removeEventListener('click', _),
                                null === document ||
                                    void 0 === document ||
                                    document.removeEventListener(
                                        'mousemove',
                ...
                function U() {
                    ...
                    const o = Object.assign(
                            Object.assign(Object.assign({}, y), e),
                            { scale: n }
                        ),
                        i = Q() ? ee(n) : void 0;
                    if (i) {
                ...
                function G() {
                    const e = { top: 0, left: 0, width: 0, height: 0 };
                    if (S) {
                ...
                function ee(e) {
                    const t = L || I('event'),
                        n = null == S ? void 0 : S.getBoundingClientRect();
                    if (!t || !n || e <= 1) return { x: 0, y: 0 };
                    const o = (t.clientX || 0) - n.left,
                        a = (t.clientY || 0) - n.top,
                        { width: s, height: r } = K(),
                        l = re(e);
                    if (e > 1) {
                    ...
                    let c = s * e,
                        u = r * e,
                        d = 0.5 * (c - s) - (((o / s) * 100) / 100) * (c - s),
                        f = 0.5 * (u - r) - (((a / r) * 100) / 100) * (u - r);
                    return (
                        (d = clamp_t(l.x[0], d, l.x[1])),
                        (f = clamp_t(l.y[0], f, l.y[1])),
                        { x: d, y: f }
                    );
                }
                function te(e = 'base') {
                    ...
                    return (
                        ...
                        e > 1 &&
                            (s > i &&
                                ((t.x[0] = 0.5 * (i - s)),
                                (t.x[1] = 0.5 * (s - i))),
                            (t.x[0] -= 0.5 * (o.left - n.left)),
                            (t.x[1] -= 0.5 * (o.left - n.left)),
                            (t.x[0] -= 0.5 * (o.left + o.width - n.right)),
                            (t.x[1] -= 0.5 * (o.left + o.width - n.right)),
                            r > a &&
                                ((t.y[0] = 0.5 * (a - r)),
                                (t.y[1] = 0.5 * (r - a))),
                            (t.y[0] -= 0.5 * (o.top - n.top)),
                            (t.y[1] -= 0.5 * (o.top - n.top)),
                            (t.y[0] -= 0.5 * (o.top + o.height - n.bottom)),
                            (t.y[1] -= 0.5 * (o.top + o.height - n.bottom))),
                        t
                    );
                }
                function le() {
                    ...
                    const e = ne(),
                        t = se(),
                        n = clamp_t(e, z.scale, t);
                    if (z.scale < e - 0.01 || z.scale > t + 0.01)
                        return void ue(v.ZoomTo, { scale: n });
                    if (F.isRunning()) return;
                    if (ye()) return;
                    const o = re(n);
                    z.x < o.x[0] || z.x > o.x[1] || z.y < o.y[0] || z.y > o.y[1]
                        ? ((z.x = clamp_t(o.x[0], z.x, o.x[1])),
                          (z.y = clamp_t(o.y[0], z.y, o.y[1])),
                          F.spring({
                              tension: 170,
                              friction: 17,
                              restDelta: 0.001,
                ...
                function ce(e) {
                    ...
                    const n = be(),
                        ...
                        s = ge(),
                        r = he();
                    (toggleClass_s(S, 'is-fullsize', a),
                        toggleClass_s(S, 'is-expanded', i),
                        toggleClass_s(S, 'is-dragging', o),
                        toggleClass_s(S, 'can-drag', n),
                        toggleClass_s(S, 'will-zoom-in', s),
                        toggleClass_s(S, 'will-zoom-out', r));
                    const l = pe(),
                        u = ve(),
                        d = me(),
                        g = !W();
                    for (const n of (null === (t = e || c) || void 0 === t
                        ? void 0
                ...
                function ue(e, t) {
                    ...
                    if (
                        e === v.Swipe &&
                        Math.abs(F.getCurrentVelocities().scale) > 0.01
                    )
                        return;
                    const o = Object.assign({}, z);
                    let a = Object.assign({}, z),
                        l = re(Q() ? o.scale : R.scale);
                    const u = F.getCurrentVelocities(),
                        d = G(),
                        f =
                            ((null === (n = (t = t || {}).currentTouch) ||
                            void 0 === n
                                ? void 0
                                : n.length) || 0) > 1,
                        h = t.velocityX || 0,
                    ...
                    switch (e) {
                        ...
                        case v.MoveDown:
                            if (ye()) {
                                ...
                                ((a.x = clamp_t(l.x[0], a.x + b, l.x[1])),
                                    (a.y = clamp_t(l.y[0], a.y + x, l.y[1])));
                            break;
                        case v.Swipe:
                            const e = (e = 0) =>
                                Math.sign(e) * Math.pow(Math.abs(e), 1.5);
                            ((a.x += clamp_t(-1e3, e(h), 1e3)),
                                (a.y += clamp_t(-1e3, e(m), 1e3)),
                                m && !h && (a.x = clamp_t(l.x[0], a.x, l.x[1])),
                                !m && h && (a.y = clamp_t(l.y[0], a.y, l.y[1])),
                                (u.x = h),
                                (u.y = m));
                            break;
                        case v.ZoomTo:
                            ...
                            break;
                        case v.ZoomIn:
                            ((a.scale = a.scale * (t.scale || 2)),
                                f || (a.scale = Math.min(a.scale, se())));
                            break;
                        case v.ZoomOut:
                            ((a.scale = a.scale * (t.scale || 0.5)),
                                f || (a.scale = Math.max(a.scale, ne())));
                            break;
                        case v.ToggleCover:
                            w = [oe(), ie()];
                            break;
                    ...
                    if (
                        (void 0 !== R.angle &&
                            ...
                            ((a.angle -= 360 * Math.floor(R.angle / 360)),
                            (R.angle -= 360 * Math.floor(R.angle / 360))),
                        w.length)
                    ) {
                    ...
                    if (
                        ...
                        let n = e - d.left,
                            s = t - d.top;
                        ((n -= 0.5 * d.width), (s -= 0.5 * d.height));
                        const r = (n - o.x) / o.scale,
                            u = (s - o.y) / o.scale;
                        ((a.x = n - r * a.scale),
                            (a.y = s - u * a.scale),
                            !f &&
                                I('bounds') &&
                                ((l = re(a.scale)),
                                (a.x = clamp_t(l.x[0], a.x, l.x[1])),
                                (a.y = clamp_t(l.y[0], a.y, l.y[1]))));
                    }
                    if (e === v.Swipe) {
                        let e = 94,
                            t = 17,
                ...
                function de() {
                    ...
                    ((f +=
                        1 !== u || 1 !== d
                            ? ` scaleX(${m(r * u)}) scaleY(${m(r * d)})`
                            : ` scale(${m(r)})`),
                        0 !== l && (f += ` rotate(${l}deg)`),
                        (C.style.width = `${m(a)}px`),
                        (C.style.height = `${m(s)}px`),
                        (C.style.transform = `${f}`),
                        H('render'));
                }
                function fe() {
                ...
                function Me() {
                    const e = 'in-fullscreen',
                        t = 'with-panzoom-in-fullscreen';
                ...
                const je = {
                        ...
                        return (
                            ...
                            (function () {
                                const e = Object.assign(
                                    Object.assign({}, x.classes),
                                    I('classes')
                                );
                                if (!c) return;
                                if (
                                    (addClass_s(c, e.container),
                                    (O = c.querySelector('.' + e.content)),
                                    !O)
                                )
                                    return;
                                (O.setAttribute('draggable', 'false'),
                                    (S = c.querySelector('.' + e.wrapper)),
                                    S ||
                                        ((S = document.createElement('div')),
                                        addClass_s(S, e.wrapper),
                                ...
                                ((C = c.querySelector('.' + e.viewport)),
                                    C ||
                                        ((C = document.createElement('div')),
                                        addClass_s(C, e.viewport),
                                ...
                                ((A = O.cloneNode(!0)),
                                    ...
                                    O instanceof HTMLPictureElement &&
                                        (O = O.querySelector('img')));
                                ...
                                if (
                                    ...
                                    (addClass_s(e, 'f-panzoom__protected'),
                                        C.appendChild(e));
                                }
                                H('initLayout');
                            })(),
                            ...
                            (function () {
                                ...
                                ((function () {
                                    ...
                                    if (
                                        null == c
                                            ? void 0
                                            : c.querySelector('.f-spinner')
                                    )
                                        return;
                                    const e = I('spinnerTpl'),
                                        t = strToHtml_e(e);
                                    t &&
                    ...
                    off: function (e, t) {
                        for (const n of e instanceof Array ? e : [e])
                            q.has(n) &&
                                q.set(
                                    n,
            ...
            ((E.l10n = { en_EN: en_EN_e }), (E.getDefaults = () => x)); // ./node_modules/@fancyapps/ui/dist/utils/getDirectChildren.js
            ...
            const extend_r = (t, ...e) => {
                ...
                for (let c = 0; c < n; c++) {
                    ...
                    Object.entries(n).forEach(([e, n]) => {
                        ...
                        (t[e] || Object.assign(t, { [e]: c }),
                            isPlainObject_t(n)
                                ? Object.assign(t[e], extend_r(t[e], n))
                                : Array.isArray(n)
                                  ? Object.assign(t, { [e]: [...n] })
                                  : Object.assign(t, { [e]: n }));
                    });
            ...
            const carousel_E = (g, x = {}, M = {}) => {
                ...
                let w,
                    ...
                    L,
                    P = 0,
                    T = Object.assign({}, carousel_h),
                    O = Object.assign({}, carousel_h),
                    R = {},
                    H = null,
                    V = null,
                    C = 0,
                ...
                function st(t, ...e) {
                    ...
                    O.on && n.push(O.on[t]);
                    for (const t of n)
                        t && t instanceof Function && t(It, ...e);
                    '*' !== t && st('*', t, ...e);
                }
                function rt() {
                    var e, n;
                        ...
                        (Dt(),
                            ...
                            !1 !== nt('enabled') &&
                                ...
                                (function () {
                                    ...
                                    const n = nt('style');
                                    if (n && isPlainObject_t(n))
                                        for (const [t, e] of Object.entries(n))
                                            H.style.setProperty(t, e);
                                    ((V = H.querySelector(`.${e.viewport}`)),
                                        V ||
                                            ((V =
                                                document.createElement('div')),
                                            addClass_s(V, e.viewport),
                                            V.append(
                                                ...getDirectChildren_e(
                                                    H,
                                                    `.${e.slide}`
                                ...
                                (function () {
                                    ...
                                    for (const t of W) {
                                        ...
                                        (null == e
                                            ? void 0
                                            : e.parentElement) === V &&
                                            (addClass_s(e, O.classes.slide),
                                            addClass_s(e, t.class),
                                            Rt(t),
                                            st('attachSlideEl', t));
                                    }
                                    st('initSlides');
                          ...
                          (function () {
                              ...
                              !w &&
                                  ...
                                  (w = f(V, t)
                                      ...
                                      .on('move', (t) => {
                                          ...
                                          if (!s)
                                              return (
                                                  carousel_m(o),
                                                  o.stopPropagation(),
                                                  void o.stopImmediatePropagation()
                                              );
                                          if (
                                              ('y' === s && !F) ||
                                              ('x' === s && F)
                                      ...
                                      .on('panstart', (t) => {
                                          !1 !== nt('gestures', t) &&
                                              (null == t ? void 0 : t.axis) ===
                                                  (F ? 'y' : 'x') &&
                                              addClass_s(V, 'is-dragging');
                                      })
                                      .on('panend', (t) => {
                                          !1 !== nt('gestures', t) &&
                                              removeClass_s(V, 'is-dragging');
                                      })
                                      .on('end', (t) => {
                                          var e, n;
                                          if (!1 === nt('gestures', t)) return;
                ...
                function ut() {
                    var t, e;
                    if (!H) return;
                    for (const t of H.querySelectorAll('[data-carousel-index]'))
                        t.innerHTML = B + '';
                    for (const t of H.querySelectorAll('[data-carousel-page]'))
                        t.innerHTML = B + 1 + '';
                    for (const t of H.querySelectorAll('[data-carousel-pages]'))
                        t.innerHTML = U.length + '';
                    ...
                    for (const t of H.querySelectorAll(
                        '[data-carousel-go-prev]'
                    ))
                        (t.toggleAttribute('aria-disabled', !$t()),
                            $t()
                                ? t.removeAttribute('tabindex')
                                : t.setAttribute('tabindex', '-1'));
                    for (const t of H.querySelectorAll(
                        '[data-carousel-go-next]'
                    ))
                        (t.toggleAttribute('aria-disabled', !qt()),
                            qt()
                                ? t.removeAttribute('tabindex')
                                : t.setAttribute('tabindex', '-1'));
                    let n = !1;
                    const i =
                        null === (e = U[B]) || void 0 === e
                            ...
                            : e.slides[0];
                    i &&
                        (i.downloadSrc || ('image' === i.type && i.src)) &&
                        (n = !0);
                    for (const t of H.querySelectorAll(
                        '[data-carousel-download]'
                    ))
                        t.toggleAttribute('aria-disabled', !n);
                }
                function ft(t) {
                    var e;
                    t ||
                ...
                function vt(t) {
                    ...
                    let l = 0;
                    for (const t of U) {
                        const e = Math.abs(t.pos - s),
                            n = Math.abs(t.pos - s - o),
                            i = Math.abs(t.pos - s + o),
                            a = Math.min(e, n, i);
                        (r.set(l, a), l++);
                    }
                    const c =
                        r.size > 0
                            ? [...r.entries()].reduce((t, e) =>
                                  e[1] < t[1] ? e : t
                              )
                            : [B, 0];
                    return parseInt(c[0]);
                ...
                function ht(t) {
                    ...
                    const i = [];
                    ((t = void 0 === t ? k : t),
                        q && (t -= Math.floor(t / e) * e || 0));
                    let o = 0;
                    for (let s of J) {
                        const r = (e = 0) => {
                            i.indexOf(s) > -1 ||
                                ((s.pos = o - t + e || 0),
                                s.offset + e > t - s.dim - D + 0.51 &&
                                    s.offset + e < t + n + $ - 0.51 &&
                                    i.push(s));
                        };
                        ((s.offset = o),
                ...
                function bt(t, e) {
                    ...
                    for (const e of Array.isArray(t) ? t : [t]) {
                        ...
                        (t.el || (t.el = document.createElement('div')),
                            st('createSlide', t),
                            n.push(t));
                    }
                ...
                function yt(t) {
                    return (
                        (isString_t(t) || t instanceof HTMLElement) &&
                            (t = { html: t }),
                        Object.assign(
                            {
                                index: -1,
                ...
                function xt(t) {
                    ...
                    if (e) {
                        if (
                            ...
                            (V.insertBefore(e, n && V.contains(n) ? n : null),
                                st('attachSlideEl', t));
                        }
                        return (ft(t), e);
                    }
                ...
                function St() {
                    ...
                    const r = nt('classes');
                    if (
                        (toggleClass_s(H, r.isLTR, !I),
                        toggleClass_s(H, r.isRTL, I),
                        toggleClass_s(H, r.isHorizontal, !F),
                        toggleClass_s(H, r.isVertical, F),
                        toggleClass_s(
                            H,
                            r.hasAdaptiveHeight,
                            nt('adaptiveHeight')
                        ...
                        et =
                            parseFloat(
                                e.getPropertyValue('--f-carousel-gap')
                            ) || 0;
                        ('visible' ===
                            e.getPropertyValue('overflow-' + (F ? 'y' : 'x')) &&
                            ((D = Math.abs(t[F ? 'top' : 'left'])),
                            ($ = Math.abs(
                                window[F ? 'innerHeight' : 'innerWidth'] -
                                    t[F ? 'bottom' : 'right']
                            ))),
                            (V.style.display = ''));
                    }
                    ...
                    for (const n of J) {
                        ...
                        if (!n.isVirtual && i && isNode_n(i)) {
                            let e = !1;
                            ((i.parentElement && i.parentElement === V) ||
                                (V.appendChild(i), (e = !0)),
                                (o = i.getBoundingClientRect()[z]),
                                e &&
                    ...
                    (!(function () {
                        ...
                        for (const t of U) {
                            ...
                            ((t.offset = c),
                                (t.pos = c),
                                !1 !== r && (t.pos -= 0.5 * (e - t.dim)),
                                l &&
                                    !q &&
                                    n > e &&
                                    (t.pos = clamp_t(0, t.pos, n - e)),
                                (c += t.dim + et));
                        }
                        const d = [];
                        let u;
                        for (const t of U) {
                            ...
                            u && Math.abs(e.pos - u.pos) < 0.1
                                ? ((u.dim += e.dim),
                                  (u.slides = [...u.slides, ...e.slides]))
                                : ((u = e), (e.index = d.length), d.push(e));
                        }
                        ...
                        0 === P
                            ? (function () {
                                  ...
                                  (void 0 !== e &&
                                      (B = It.getPageIndex(e) || 0),
                                      (B = clamp_t(0, B, U.length - 1)),
                                      (k =
                                          (null === (t = U[B]) || void 0 === t
                                              ? void 0
                                              : t.pos) || 0),
                ...
                function jt(t) {
                    ...
                    (t.removeEventListener('animationend', Lt),
                        removeClass_s(t, o.join(' ')),
                        K.delete(n));
                }
                function At() {
                    if (!V) return;
                ...
                function Lt(t) {
                    var e;
                    'f-' ===
                        (null === (e = t.animationName) || void 0 === e
                            ? void 0
                            : e.substring(0, 2)) &&
                        (jt(t.target),
                        K.size ||
                            (removeClass_s(H, 'in-transition'),
                            !N &&
                                Math.abs(It.getPosition(!0) - _) < 0.5 &&
                                ((N = !0), st('settle'))),
                        Ct());
                }
                function Pt(t) {
                    ...
                    if (n.closest('[data-carousel-go-prev]'))
                        return (carousel_m(t), void It.prev());
                    if (n.closest('[data-carousel-go-next]'))
                        return (carousel_m(t), void It.next());
                    const i = n.closest('[data-carousel-go-to]');
                    if (i)
                        return (
                            carousel_m(t),
                            void It.goTo(
                                parseFloat(i.dataset.carouselGoTo || '') || 0
                            )
                        );
                    if (n.closest('[data-carousel-download]')) {
                        ...
                        if (
                            n &&
                            (n.downloadSrc || ('image' === n.type && n.src))
                        ) {
                            const t = n.downloadFilename,
                                e = document.createElement('a'),
                                i = n.downloadSrc || n.src || '';
                            ((e.href = i),
                                (e.target = '_blank'),
                                (e.download = t || i),
                                e.click());
                ...
                function Tt(t) {
                    ...
                    const n = t.el;
                    n &&
                        (null === (e = n.querySelector('.f-spinner')) ||
                            void 0 === e ||
                            e.remove());
                }
                function Ot(t) {
                    ...
                    const n = t.el;
                    n &&
                        (null === (e = n.querySelector('.f-html.is-error')) ||
                            void 0 === e ||
                            e.remove(),
                ...
                function Rt(t) {
                    ...
                    if (s && s instanceof HTMLElement) {
                        if (t.index !== B) return;
                        if (
                            (isString_t(o) && (s.innerHTML = it(o + '')),
                            o instanceof HTMLElement)
                        ) {
                            if (o.parentElement === s) return;
                            ((s.innerHTML = ''),
                                o.parentElement && (o = o.cloneNode(!0)),
                                s.append(o));
                        }
                        return;
                    }
                    ...
                    (!r &&
                        o instanceof HTMLElement &&
                        o.classList.contains('f-caption') &&
                        (r = o),
                        r ||
                            ((r = document.createElement('div')),
                            addClass_s(r, 'f-caption'),
                            isString_t(o)
                                ? (r.innerHTML = it(o + ''))
                                : o instanceof HTMLElement &&
                                  (o.parentElement && (o = o.cloneNode(!0)),
                    ...
                    (r.setAttribute('id', l),
                        (r.dataset.selectable = 'true'),
                        addClass_s(i, 'has-caption'),
                ...
                function Ht(e, i = {}) {
                    ...
                    let { transition: l, tween: u } = Object.assign(
                        { transition: O.transition, tween: O.tween },
                        i || {}
                    );
                    if (!H || !S) return;
                    const f = U.length;
                    ...
                    if (
                        (function (t, e) {
                            ...
                            if (
                                ...
                                return !1;
                            for (const t of Q) if (C - t.dim > 0.5) return !1;
                            if (D > 0.5 || $ > 0.5) return;
                            const r = U.length;
                            let l = t > B ? 1 : -1;
                            ((t = q ? ((t % r) + r) % r : clamp_t(0, t, r - 1)),
                                I && (l *= -1));
                            const u =
                                    null === (i = U[B]) || void 0 === i
                                        ? void 0
                                        : i.slides[0],
                                f = null == u ? void 0 : u.index,
                                v =
                                    null === (o = U[t]) || void 0 === o
                                        ? void 0
                                        : o.slides[0],
                                p = null == v ? void 0 : v.index,
                                g =
                                    null === (s = U[t]) || void 0 === s
                                        ? void 0
                                        : s.pos;
                            ...
                            return (
                                ...
                                m &&
                                    (K.add(f),
                                    (m.style.transform = ''),
                                    m.addEventListener('animationend', Lt),
                                    removeClass_s(m, O.classes.isSelected),
                                    (m.inert = !1),
                                    addClass_s(
                                        m,
                                        `f-${e}Out to-${l > 0 ? 'next' : 'prev'}`
                                    )),
                                h &&
                                    (K.add(p),
                                    (h.style.transform = ''),
                                    h.addEventListener('animationend', Lt),
                                    addClass_s(h, O.classes.isSelected),
                                    (h.inert = !1),
                                    addClass_s(
                                        h,
                                        `f-${e}In from-${l > 0 ? 'prev' : 'next'}`
                                    )),
                                Ct(),
                                !0
                            );
                    ...
                    !1 !== l && isPlainObject_t(u)
                        ? S.spring(extend_r({}, O.tween, u))
                              .from({ pos: k })
                              .to({ pos: _ })
                              .start()
                        : ((k = _), dt(), Ct(), N || ((N = !0), st('settle')));
                }
                function Vt(t) {
                    var e;
                    let n = k;
                ...
                function Ct() {
                    ...
                    let l;
                    for (const o of J) {
                        const s = K.has(o.index),
                            r = Q.indexOf(o) > -1,
                            a =
                                (null === (t = null == i ? void 0 : i.slides) ||
                                void 0 === t
                                    ? void 0
                                    : t.indexOf(o)) > -1;
                        ...
                        if (
                            ...
                            const t = (
                                c.firstElementChild || c
                            ).getBoundingClientRect().height;
                            l = null == l ? t : Math.max(l, t);
                        }
                    }
                    (V && l && (V.style.height = `${l}px`),
                        [
                            ...getDirectChildren_e(V, `.${O.classes.slide}`),
                        ].forEach((t) => {
                            toggleClass_s(t, O.classes.isSelected, e.has(t));
                            const n =
                                W[parseInt(t.getAttribute('index') || '-1')];
                            if (!n) return (t.remove(), void jt(t));
                            const i = K.has(n.index),
                                o = Q.indexOf(n) > -1;
                            ...
                            (i ||
                                ((a = F ? 0 : I ? -1 * l : l),
                                (c = F ? l : 0),
                                (d = map_t(a, 0, n.dim, 0, 100)),
                                (f = map_t(c, 0, n.dim, 0, 100))),
                                s instanceof Function && !i
                                    ? s(It, n, {
                                          x: a,
                                          y: c,
                                          xPercent: d,
                ...
                function Dt() {
                    (null == H || H.removeEventListener('click', Pt),
                    ...
                    for (const t of W) {
                        ...
                        n &&
                            ...
                            t.isVirtual
                                ...
                                : (jt(n),
                                  (n.style.transform = ''),
                                  V && !V.contains(n) && V.appendChild(n)));
                    }
                    ...
                    ((R = {}),
                        ...
                        null == S || S.destroy(),
                        (S = void 0));
                    for (const [t, e] of Object.entries(O.classes || {}))
                        'container' !== t && removeClass_s(H, e);
                ...
                const It = {
                    ...
                    getPageProgress: function (t, e) {
                        ...
                        if (q && !0 !== e) {
                            ...
                            ((l -= t * o),
                                (r = [r + o, r, r - o].reduce(function (t, e) {
                                    return Math.abs(e - l) < Math.abs(t - l)
                                        ? e
                                        : t;
                                })));
                        }
                    ...
                    getPageVisibility: function (t) {
                        ...
                        return s > i && s + n.dim < i + o
                            ? 1
                            : s < i
                              ? (s + n.dim - i) / n.dim || 0
                              : (s + n.dim > i + o && (i + o - s) / n.dim) || 0;
                    },
                    getPages: function () {
                        return U;
                    },
                    ...
                    off: function (t, e) {
                        for (const n of t instanceof Array ? t : [t])
                            ot.has(n) &&
                                ot.set(
                                    n,
                                    ot.get(n).filter((t) => t !== e)
                                );
                        return It;
                    },
                    on: function (t, e) {
                    ...
                    remove: function (t) {
                        ...
                        return (
                            e &&
                                (st('removeSlide', e),
                                e.el &&
                                    (jt(e.el), e.el.remove(), (e.el = void 0)),
                                W.splice(t, 1),
                                ct(Y),
                                St(),
                                (k = clamp_t(G, k, X)),
                    ...
                    showError: function (t, e) {
                        ...
                        if (n) {
                            ...
                            (addClass_s(i, 'f-html'),
                                addClass_s(i, 'is-error'),
                                (i.innerHTML = it(e || '<p>{{ERROR}}</p>')),
                                (t.htmlEl = i),
                                addClass_s(n, 'has-html'),
                                addClass_s(n, 'has-error'),
                    ...
                    showLoading: function (t) {
                        ...
                        if (!e || n) return It;
                        const i = nt('spinnerTpl'),
                            o = strToHtml_e(i);
                        return (
                            o &&
                                (addClass_s(o, 'f-spinner'),
            ...
            ((carousel_E.l10n = { en_EN: en_EN_o }),
                (carousel_E.getDefaults = () => carousel_h)); // ./node_modules/@fancyapps/ui/dist/utils/scrollLock.js

            /*! License details at fancyapps.com/license */
            const scrollLock_t = (
                t = !0,
                e = '--f-scrollbar-compensate',
                s = '--f-body-margin',
                o = 'hide-scrollbar'
            ) => {
                const n = document,
                ...
                carousel_zoomable_s = () => {
                    ...
                    function l(e, o) {
                        ...
                        let i = (
                            isPlainObject_t(n)
                                ? Object.assign(
                                      Object.assign({}, carousel_zoomable_a),
                                      n
                                  )
                                : carousel_zoomable_a
                        )[e];
                    ...
                    function c() {
                        s &&
                            !1 !== s.getOptions().Zoomable &&
                            (s.on('addSlide', f),
                            s.on('removeSlide', u),
                            s.on('attachSlideEl', g),
                            s.on('click', d),
                            s.on('change', r),
                            s.on('ready', r));
                    }
                    function r() {
                        m();
                        const t =
                            (null == s ? void 0 : s.getVisibleSlides()) || [];
                        if (
                            t.length > 1 ||
                            'slide' ===
                                (null == s ? void 0 : s.getOption('transition'))
                        )
                            for (const e of t) {
                                ...
                                t &&
                                    ...
                                    t.execute(
                                        v.ZoomTo,
                                        Object.assign({}, t.getStartPosition())
                                    );
                            }
                    }
                    function d(t, e) {
                        ...
                        o &&
                            !e.defaultPrevented &&
                            o.dataset.panzoomAction &&
                            p(o.dataset.panzoomAction);
                    }
                    function f(t, i) {
                        const a = i.el;
                        if (!s || !a || i.panzoomRef) return;
                        const c = i.src || i.lazySrc || '',
                            r = i.alt || i.caption || `Image #${i.index}`,
                            d = i.srcset || i.lazySrcset || '',
                            f = i.sizes || i.lazySizes || '';
                        if (
                            c &&
                            isString_t(c) &&
                            !i.html &&
                            ...
                            ((i.type = 'image'),
                                (i.thumbSrc = i.thumbSrc || c));
                            let t = l('tpl', i);
                            ((t = replaceAll_n(t, '{{src}}', c + '')),
                                (t = replaceAll_n(t, '{{srcset}}', d + '')),
                                (t = replaceAll_n(t, '{{sizes}}', f + '')),
                        ...
                        const g =
                                i.width && 'auto' !== i.width
                                    ? parseFloat(i.width + '')
                                    : 'auto',
                            p =
                                i.height && 'auto' !== i.height
                                    ? parseFloat(i.height + '')
                                    : 'auto',
                            z = E(
                                a,
                        ...
                        (z.on('*', (t, e, ...o) => {
                            s &&
                                ...
                                'error' === e &&
                                    ((i.state = 2),
                                    null == s ||
                                        s.showError(i, '{{IMAGE_ERROR}}')),
                                s.emit(`panzoom:${e}`, i, ...o),
                                'ready' === e && s.emit('contentReady', i),
                                i.index ===
                                    (null == s ? void 0 : s.getPageIndex()) &&
                                    m());
                        }),
                            (i.panzoomRef = z));
                    }
                    function u(t, e) {
                        e.panzoomRef &&
                            (e.panzoomRef.destroy(), (e.panzoomRef = void 0));
                    }
                    function g(t, e) {
            ...
            const carousel_sync_e = {
                ...
                carousel_sync_i = () => {
                    ...
                    function o() {
                        ...
                        return isPlainObject_t(t)
                            ? Object.assign(
                                  Object.assign({}, carousel_sync_e),
                                  t
                              )
                            : carousel_sync_e;
                    }
                    function s(n) {
                        ...
                        i &&
                            n &&
                            ((t = n),
                            (i.getOptions().classes = Object.assign(
                                Object.assign({}, i.getOptions().classes),
                                { isSelected: '' }
                            )),
                            (i.getOptions().initialSlide =
                                (null ===
                                    (s =
                                        null === (e = t.getPage()) ||
                                        void 0 === e
                                    ...
                                    ? void 0
                                    : s.index) || 0),
                            o().syncOnChange && i.on('change', c),
                            o().syncOnClick && i.on('click', g),
                            o().syncOnHover &&
                                (null === (l = i.getViewport()) ||
                                    void 0 === l ||
                                    l.addEventListener('mouseover', u)),
                            (function () {
                                if (!i || !t) return;
                                (i.on('ready', d),
                                    i.on('refresh', a),
                    ...
                    function c() {
                        ...
                        if (i && t) {
                            const e =
                                    (null === (n = i.getPage()) || void 0 === n
                                        ? void 0
                                        : n.slides) || [],
                                o = t.getPageIndex(e[0].index || 0);
                            (o > -1 &&
                                t.goTo(
                                    o,
                                    i.hasNavigated()
                    ...
                    function r() {
                        var n;
                        if (i && t) {
                            const e = i.getPageIndex(
                                (null === (n = t.getPage()) || void 0 === n
                                    ? void 0
                                    : n.slides[0].index) || 0
                            );
                            (e > -1 &&
                    ...
                    function g(n, e) {
                        ...
                        if (!i || !t) return;
                        if (
                            null === (o = i.getTween()) || void 0 === o
                                ? void 0
                                : o.isRunning()
                        )
                            return;
                        const s =
                            null == i ? void 0 : i.getOptions().classes.slide;
                        if (!s) return;
                        const l = s ? e.target.closest(`.${s}`) : null;
                        if (l) {
                            const n =
                                    parseInt(l.getAttribute('index') || '') ||
                                    0,
                                e = t.getPageIndex(n);
                            t.goTo(e);
                        }
                    ...
                    function a() {
                        ...
                        if (i && t) {
                            ...
                            (e > -1 && i.goTo(e, { tween: !1, transition: !1 }),
                                v());
                        }
                    }
                    function f(n, e) {
                    ...
                    function v() {
                        ...
                        const s =
                            (null ===
                                ...
                                ? void 0
                                : e.index) || 0;
                        for (const n of (null == i ? void 0 : i.getSlides()) ||
                            [])
                            null === (o = n.el) ||
                                void 0 === o ||
                                o.classList.toggle(
                    ...
                    return {
                        ...
                        destroy: function () {
                            var n;
                            (null == i || i.off('ready', d),
                                null == i || i.off('refresh', a),
                                null == i || i.off('change', c),
                                null == i || i.off('click', g),
                                null ===
                                    (n =
                                        null == i ? void 0 : i.getViewport()) ||
                                    void 0 === n ||
                                    n.removeEventListener('mouseover', u),
                                null == t || t.off('change', r),
                                null == t || t.off('filter', f),
                                (t = void 0),
                                null == i || i.off('initSlides', l),
                                (i = void 0));
                        },
                        getTarget: function () {
                            return t;
            ...
            /*! License details at fancyapps.com/license */
            const carousel_lazyload_s = { showLoading: !0, preload: 1 },
                carousel_lazyload_n = 'is-lazyloading',
                carousel_lazyload_o = 'is-lazyloaded',
                carousel_lazyload_l = 'has-lazyerror',
                carousel_lazyload_i = () => {
                    let i;
                    function d() {
                        const e = null == i ? void 0 : i.getOptions().Lazyload;
                        return isPlainObject_t(e)
                            ? Object.assign(
                                  Object.assign({}, carousel_lazyload_s),
                                  e
                              )
                            : carousel_lazyload_s;
                    }
                    function r(t) {
                        ...
                        const c =
                            ...
                            u = Array.from(r.querySelectorAll(c));
                        r.matches(c) && u.push(r);
                        for (const r of u) {
                            const c = r.dataset.lazySrc,
                                u = r.dataset.lazySrcset,
                                f = r.dataset.lazySizes,
                                m = r.dataset.lazyBg,
                                y =
                                    (r instanceof HTMLImageElement ||
                                        r instanceof HTMLSourceElement) &&
                                    (c || u),
                                z = r instanceof HTMLElement && m;
                            if (!y && !z) continue;
                            const g = c || u || m;
                            if (g) {
                                if (y && g) {
                                    ...
                                    (d().showLoading &&
                                        (null == i || i.showLoading(t)),
                                        r.addEventListener('load', () => {
                                            (null == i || i.hideLoading(t),
                                                removeClass_s(
                                                    r,
                                                    carousel_lazyload_l
                                                ),
                                        ...
                                        r.classList.add(carousel_lazyload_n),
                                        m ||
                                            null == i ||
                                            i.emit('lazyLoad:load', t, r, g),
                                        c && (r.src = c),
                                        u && (r.srcset = u),
                                        f && (r.sizes = f));
                                } else if (z) {
                                    if (!document.body.contains(r)) {
                                        document.createElement('img').src = m;
                                    }
                                    r.style.backgroundImage = `url('${m}')`;
                                }
                                (delete r.dataset.lazySrc,
                                    delete r.dataset.lazySrcset,
                                    delete r.dataset.lazySizes,
                    ...
                    function c() {
                        if (!i) return;
                        const e = [...i.getVisibleSlides()],
                            t = d().preload;
                        if (t > 0) {
                            const a = i.getPosition(),
                                s = i.getViewportDim();
                            e.push(
                                ...i.getVisibleSlides(a + s * t),
                                ...i.getVisibleSlides(a - s * t)
                            );
                        }
            ...
            const carousel_arrows_r =
                ...
                carousel_arrows_l = () => {
                    ...
                    function a() {
                        ...
                        return isPlainObject_t(t)
                            ? Object.assign(
                                  Object.assign({}, carousel_arrows_s),
                                  t
                              )
                            : carousel_arrows_s;
                    }
                    function u(e) {
                        if (!r) return;
                        const o =
                                `<button data-carousel-go-${e} tabindex="0" class="f-button is-arrow is-${e}" title="{{${e.toUpperCase()}}}">` +
                                a()[`${e}Tpl`] +
                                '</button',
                            i = strToHtml_e(r.localize(o)) || void 0;
                    ...
                    function c() {
                        ...
                        (null == i || i.remove(),
                            ...
                            (l = void 0),
                            null ===
                                (t = null == r ? void 0 : r.getContainer()) ||
                                void 0 === t ||
                                t.classList.remove('has-arrows'));
                    }
                    function d() {
                        r &&
                        !1 !== r.getOptions().Arrows &&
                        r.getPages().length > 1
                            ? (!(function () {
                                  if (!r) return;
            ...
            const buttons_t =
                ...
                buttons_v = {};
            for (const [t, M] of Object.entries(buttons_o))
                buttons_v[t] = {
                ...
                carousel_toolbar_r = () => {
                    ...
                    function u(e) {
                        ...
                        let n = (
                            isPlainObject_t(o)
                                ? Object.assign(
                                      Object.assign({}, carousel_toolbar_a),
                                      o
                                  )
                                : carousel_toolbar_a
                        )[e];
                    ...
                    function c() {
                        var a, c;
                        if (!(null == l ? void 0 : l.getOptions().Toolbar))
                            return;
                        if (!l || r) return;
                        ...
                        if (!f) return;
                        const g = u('absolute'),
                            p = l.getSlides().length > 1;
                        let b = !1,
                            m = !1;
                        for (const t of l.getSlides())
                            (t.panzoomRef && (b = !0),
                                (t.downloadSrc ||
                                    ('image' === t.type && t.src)) &&
                                    (m = !0));
                        const v =
                                (null === (a = l.getPlugins().Thumbs) ||
                                void 0 === a
                                    ? void 0
                                    : a.isEnabled()) || !1,
                            h = (p && l.getPlugins().Autoplay) || !1,
                            E =
                                l.getPlugins().Fullscreen &&
                                (document.fullscreenEnabled ||
                                    document.webkitFullscreenEnabled);
                        if (('auto' === f && (f = b), !f)) return;
                        ((r =
                            d.querySelector('.f-carousel__toolbar') || void 0),
                            r ||
                                ((r = document.createElement('div')),
                                r.classList.add('f-carousel__toolbar')));
                        const y = u('display'),
                            j = extend_r({}, carousel_toolbar_s, u('items'));
                        for (const i of ['left', 'middle', 'right']) {
                            const s = y[i] || [],
                                a = document.createElement('div');
                            (a.classList.add('f-carousel__toolbar__column'),
                                a.classList.add(`is-${i}`));
                            for (const i of s) {
                                let s;
                                if (isString_t(i)) {
                        ...
                        if (r.childElementCount) {
                            if (
                                (g && r.classList.add('is-absolute'),
                                !r.parentElement)
                            ) {
                                const t = u('parentEl');
                                t
                                    ? t.insertAdjacentElement('afterbegin', r)
                                    : null === (c = l.getViewport()) ||
                                      void 0 === c ||
                                ...
                                null ===
                                    (t =
                                        null == l
                                            ...
                                            : l.getContainer()) ||
                                    void 0 === t ||
                                    t.classList.remove('has-toolbar'),
                                null == r || r.remove(),
                                (r = void 0));
                        },
                        add: function (t, e) {
                ...
                carousel_autoplay_o = () => {
                    ...
                    function u(e) {
                        ...
                        let a = (
                            isPlainObject_t(i)
                                ? Object.assign(
                                      Object.assign({}, carousel_autoplay_n),
                                      i
                                  )
                                : carousel_autoplay_n
                        )[e];
                    ...
                    function g() {
                        ...
                        i = setTimeout(() => {
                            o &&
                                ...
                                !s &&
                                (o.isInfinite() ||
                                o.getPageIndex() !== o.getPages().length - 1
                                    ? o.next()
                                    : o.goTo(0));
                        }, t);
                    }
                    function c() {
                        ...
                        if (
                            !o ||
                            o.getPages().length < 2 ||
                            !1 === o.getOptions().Autoplay
                        )
                            return;
                        if (a) return;
                        ((a = !0),
                            o.emit('autoplay:start', u('timeout')),
                            addClass_s(o.getContainer(), 'has-autoplay'),
                            null === (t = o.getTween()) ||
                                void 0 === t ||
                                t.on('start', b));
                        ...
                        (n &&
                            u('pauseOnHover') &&
                            matchMedia('(hover: hover)').matches &&
                            (n.addEventListener('mouseenter', E, !1),
                            n.addEventListener('mouseleave', w, !1)),
                            o.on('change', P),
                            o.on('settle', y),
                            o.on('contentReady', p),
                            o.on('panzoom:touchStart', d),
                            o.on('panzoom:wheel', d),
                            o.isSettled() && g());
                    }
                    function d() {
                        var t;
                        if ((f(), v(), o)) {
                            if (a) {
                                ...
                                e &&
                                    (e.classList.remove('has-autoplay'),
                                    e.removeEventListener('mouseenter', E, !1),
                                    e.removeEventListener('mouseleave', w, !1));
                            }
                            (o.off('change', P),
                                o.off('settle', y),
                                o.off('contentReady', p),
                                o.off('panzoom:touchStart', d),
                    ...
                    const O = {
                        ...
                        destroy: function () {
                            (d(),
                                null == o || o.off('ready', m),
                                null == o || o.off('click', h),
                                (o = void 0));
                        },
                        isEnabled: () => a,
                        pause: function () {
            ...
            const carousel_thumbs_c = () => {
                ...
                function b(e) {
                    ...
                    let o = (
                        isPlainObject_t(n)
                            ? Object.assign(
                                  Object.assign({}, carousel_thumbs_u),
                                  n
                              )
                            : carousel_thumbs_u
                    )[e];
                ...
                function y() {
                    if (!c) return !1;
                    if (!1 === (null == c ? void 0 : c.getOptions().Thumbs))
                        return !1;
                    let t = 0;
                ...
                function T(t) {
                    const e = t.thumb
                        ...
                        o =
                            void 0 === t.thumbAlt
                                ? `Thumbnail #${(t.index || 0) + 1}`
                                : t.thumbAlt + '';
                    let i = b('thumbTpl');
                    return (
                        (i = replaceAll_n(i, '{{alt}}', o)),
                        (i = replaceAll_n(i, '{{src}}', e + '')),
                        (i = replaceAll_n(i, '{{index}}', `${t.index || 0}`)),
                        (i = replaceAll_n(
                            i,
                            '{{page}}',
                            `${(t.index || 0) + 1}`
                ...
                function E(t = !1) {
                    ...
                    if (((o.container = o.container || 'f-thumbs'), !f)) {
                        ...
                        (null == t
                            ? void 0
                            : t.classList.contains(o.container)) && (f = t);
                    }
                    if (!f) {
                    ...
                    (addClass_s(f, o.container),
                        addClass_s(f, 'f-thumbs'),
                        addClass_s(f, `is-${b('type')}`),
                        t && addClass_s(f, 'is-hidden'));
                }
                function P() {
                    if (!f || !S()) return;
                    ((m = document.createElement('div')),
                        addClass_s(m, 'f-thumbs__viewport'));
                    let t = '';
                    for (const e of C()) {
                        'string' == typeof (e.html || '') && (t += L(e));
                    }
                    ((m.innerHTML = t),
                        f.append(m),
                        f.addEventListener('click', (t) => {
                            t.preventDefault();
                            const e = t.target.closest('[index]'),
                                n = parseInt(
                                    (null == e
                                        ? void 0
                                        : e.getAttribute('index')) || '-1'
                                );
                            c && n > -1 && c.goTo(n);
                        }),
                            ...
                            (t) => {
                                t.forEach((t) => {
                                    t.isIntersecting &&
                                        ...
                                        t.target.removeAttribute(
                                            'data-lazy-src'
                                        ),
                                        null == g || g.unobserve(t.target));
                                });
                            },
                            { root: m, rootMargin: '100px' }
                        )),
                ...
                function w() {
                    ...
                    ((d = carousel_thumbs_a(f, o, {
                        ...
                        d.on('ready', () => {
                            (addClass_s(f, 'is-syncing'),
                                null == c || c.emit('thumbs:ready'),
                                x() && (null == c || c.on('render', $)));
                        }),
                        d.on('destroy', () => {
                            null == c || c.emit('thumbs:destroy');
                        }),
                        d.init(),
                        null === (t = d.getGestures()) ||
                            void 0 === t ||
                            t.on('start', () => {
                                p = !1;
                            }),
                        ...
                        addClass_s(c.getContainer(), 'has-thumbs'),
                        R());
                }
                function j() {
                    y() && b('showOnStart') && (E(), P());
                ...
                function A() {
                    ...
                    y() &&
                        (w(),
                        null == c || c.on('addSlide', z),
                        null == c || c.on('removeSlide', _),
                        null == c || c.on('click', I),
                        null == c || c.on('refresh', q),
                        null === (t = null == c ? void 0 : c.getGestures()) ||
                            void 0 === t ||
                            t.on('start', M),
                        D(!0));
                }
                ...
                function $() {
                    ...
                    (null == f ||
                        f.classList.toggle(
                            'is-syncing',
                            !1 === (null == c ? void 0 : c.hasNavigated()) ||
                                (null ===
                                    (t = null == c ? void 0 : c.getTween()) ||
                                void 0 === t
                                    ? void 0
                                    : t.isRunning())
                        ),
                        R(),
                        (null === (e = null == c ? void 0 : c.getGestures()) ||
                        void 0 === e
                            ? void 0
                            : e.isPointerDown()) &&
                            (function () {
                                ...
                                const t = d.getTween(),
                                    e = d.getPages(),
                                    n = c.getPageIndex() || 0,
                                    i = c.getPageProgress() || 0;
                                if (!(c && e && e[n] && t)) return;
                                const l = t.isRunning()
                                    ? t.getCurrentValues().pos
                                    : d.getPosition();
                                if (void 0 === l) return;
                                let r = e[n].pos + i * (h - v);
                                ((r = clamp_t(
                ...
                function _(t, e) {
                    ...
                    d
                        ...
                        : m &&
                          (null ===
                              (n = m.querySelector(`[index="${e.index}"]`)) ||
                              void 0 === n ||
                              n.remove());
                }
                function I(t, e) {
                    ...
                    e.defaultPrevented ||
                        'toggle' !==
                            ...
                            void 0 === n
                                ...
                                : n.thumbsAction) ||
                        (f || (E(!0), P(), w()),
                        f && f.classList.toggle('is-hidden'));
                }
                function q() {
                    D();
                }
                ...
                function R() {
                    ...
                    for (const n of t) {
                        ...
                        ((o = Math.max(-1, Math.min(1, o))),
                            o > -1 &&
                                o < 1 &&
                                (e += 0.5 * h * (1 - Math.abs(o))),
                            (o = Math.round(1e4 * o) / 1e4),
                            (e = Math.round(1e4 * e) / 1e4),
                            t.style.setProperty('--progress', `${Math.abs(o)}`),
                            t.style.setProperty(
                                '--shift',
                                `${(null == c ? void 0 : c.isRTL()) ? -1 * e : e}px`
                            ),
                            o > -1 &&
                                o < 1 &&
                                (e += 0.5 * h * (1 - Math.abs(o))));
                ...
                return {
                    ...
                    destroy: function () {
                        var t, e;
                        (S() && (null == c || c.emit('thumbs:destroy')),
                            null == c || c.off('ready', A),
                            null == c || c.off('initSlides', j),
                            null == c || c.off('change', O),
                            null == c || c.off('render', $),
                            null == c || c.off('addSlide', z),
                            null == c || c.off('click', I),
                            null == c || c.off('refresh', q),
                            null ===
                                (t = null == c ? void 0 : c.getGestures()) ||
                                void 0 === t ||
                                t.off('start', M),
                            null ===
                                (e = null == c ? void 0 : c.getContainer()) ||
                                void 0 === e ||
                                e.classList.remove('has-thumbs'),
                            (c = void 0),
                            null == d || d.destroy(),
                            (d = void 0),
                            null == f || f.remove(),
                ...
                carousel_html_i = () => {
                    ...
                    function l(t, a) {
                        ...
                        if (!l) {
                            if (
                                ...
                                t &&
                                    ((i = `https://maps.google.${t[1]}/?ll=${(t[2] ? t[2] + '&z=' + Math.floor(parseFloat(t[3])) + (t[4] ? t[4].replace(/^\//, '&') : '') : t[4] + '').replace(/\?/, '&')}&output=${t[4] && t[4].indexOf('layer=c') > 0 ? 'svembed' : 'embed'}`),
                                    (l = 'gmap'));
                            }
                            if (!l) {
                                const t = i.match(
                                ...
                                t &&
                                    ((i = `https://maps.google.${t[1]}/maps?q=${t[2].replace('query=', 'q=').replace('api=1', '')}&output=embed`),
                                    (l = 'gmap'));
                            }
                            ((a.src = i), (a.type = l));
                        }
                        ...
                        ('iframe' !== l.type &&
                            ...
                            (function (e) {
                                ...
                                ((l.onerror = () => {
                                    i &&
                                        1 === i.getState() &&
                                        i.showError(e, '{{IFRAME_ERROR}}');
                                }),
                                    (l.src = e.src));
                                const o = document.createElement('div');
                                if (
                                    (o.classList.add('f-html'),
                                    o.append(l),
                                    e.width)
                                ) {
                                    let t = `${e.width}`;
                                ...
                                if (e.aspectRatio) {
                                    ...
                                    ((o.style.aspectRatio = `${e.aspectRatio}`),
                                        (o.style[
                                            t.width > t.height
                                                ? 'width'
                                                : 'height'
                                ...
                                ((e.contentEl = l),
                                    (e.htmlEl = o),
                                    e.el.classList.add('has-html'),
                                    e.el.classList.add('has-iframe'),
                                    e.el.classList.add(`has-${e.type}`),
                                    e.el.prepend(o),
                                    i.emit('contentReady', e));
                            })(l);
                    }
                    function n(t, e) {
                        var a, l;
                    ...
                    return {
                        init: function (t) {
                            ((i = t),
                                i.on('addSlide', l),
                                i.on('attachSlideEl', o),
                                i.on('detachSlideEl', n));
                        },
                        destroy: function () {
                            (null == i || i.off('addSlide', l),
                                null == i || i.off('attachSlideEl', o),
                                null == i || i.off('detachSlideEl', n),
                                (i = void 0));
                        },
                    };
            ...
            const carousel_video_n = (t, e = {}) => {
                ...
                carousel_video_l = () => {
                    ...
                    function r() {
                        ...
                        return isPlainObject_t(e)
                            ? Object.assign(
                                  Object.assign({}, carousel_video_i),
                                  e
                              )
                            : carousel_video_i;
                    }
                    ...
                    function d(t, o) {
                        ...
                        if (!l || 'youtube' === l) {
                            ...
                            if (t) {
                                const e = Object.assign(
                                        Object.assign({}, r().youtube),
                                        o.youtube || {}
                                    ),
                                    s = `www.youtube${e.nocookie ? '-nocookie' : ''}.com`,
                                    a = carousel_video_n(i, e),
                                    c = encodeURIComponent(t[2]);
                                ((o.videoId = c),
                                    (o.src = `https://${s}/embed/${c}?${a}`),
                                    (o.thumb =
                                        o.thumb ||
                        ...
                        if (!l || 'vimeo' === l) {
                            ...
                            if (t) {
                                const e = Object.assign(
                                        Object.assign({}, r().vimeo),
                                        o.vimeo || {}
                                    ),
                                    s = carousel_video_n(i, e),
                                    a = encodeURIComponent(t[2]),
                                    c = t[5] || '';
                                ((o.videoId = a),
                                    (o.src = `https://player.vimeo.com/video/${a}?${c ? `h=${c}${s ? '&' : ''}` : ''}${s}`),
                                    (l = 'vimeo'));
                            }
                        }
                        o.type = l;
                    ...
                    function m(t, n) {
                        ('html5video' === n.type &&
                            (function (t) {
                                ...
                                const { el: n, src: i } = t;
                                if (!n || !i) return;
                                const s = t.html5videoTpl || r().html5videoTpl,
                                    a =
                                        t.html5videoFormat ||
                                        r().html5videoFormat;
                                if (!s) return;
                                ...
                                (m.classList.add('f-html'),
                                    m.append(d),
                                    (t.contentEl = d),
                                    (t.htmlEl = m),
                                    n.classList.add(`has-${t.type}`),
                                    n.prepend(m),
                                    h(t),
                                    l.emit('contentReady', t));
                            })(n),
                            ('youtube' !== n.type && 'vimeo' !== n.type) ||
                                (function (t) {
                                    if (!l || !t.el || !t.src) return;
                                    const e = document.createElement('iframe');
                                    (e.classList.add('f-iframe'),
                                        e.setAttribute(
                                            'id',
                                            `f-iframe_${t.videoId}`
                                        ));
                        ...
                        (t && void 0 !== t.autoplay
                            ...
                            (function () {
                                ...
                                const o = () => {
                                    if (
                                        t.contentEl &&
                                        t.contentEl instanceof
                                            HTMLIFrameElement &&
                                        t.contentEl.contentWindow
                                    ) {
                                        let e;
                                        if (
                                            'true' === t.contentEl.dataset.ready
                                        )
                                            return (
                                                (e =
                                                    'youtube' === t.type
                                                ...
                                                e &&
                                                    t.contentEl.contentWindow.postMessage(
                                                        JSON.stringify(e),
                                                        '*'
                                                    ),
                    ...
                    function h(t) {
                        ...
                        if (
                            ...
                            if (t.aspectRatio) {
                                const o = t.aspectRatio.split('/'),
                                    n = parseFloat(o[0].trim()),
                                    i = o[1] ? parseFloat(o[1].trim()) : 0,
                                    l = n && i ? n / i : n;
                                e.offsetHeight;
                                const s = e.getBoundingClientRect(),
                                    r = l < (s.width || 1) / (s.height || 1);
                                ((e.style.aspectRatio = `${t.aspectRatio}`),
                                    (e.style.width = r ? 'auto' : ''),
                                    (e.style.height = r ? '' : 'auto'));
                            }
                        }
                    }
                    function v() {
                    ...
                    return {
                        init: function (t) {
                            ((l = t),
                                l.on('addSlide', d),
                                l.on('attachSlideEl', m),
                                l.on('detachSlideEl', u),
                                l.on('ready', p),
                                l.on('change', f),
                                l.on('settle', p),
                                l.on('refresh', v),
                        ...
                        destroy: function () {
                            (null == l || l.off('addSlide', d),
                                null == l || l.off('attachSlideEl', m),
                                null == l || l.off('detachSlideEl', u),
                                null == l || l.off('ready', p),
                                null == l || l.off('change', f),
                                null == l || l.off('settle', p),
                                null == l || l.off('refresh', v),
            ...
            const carousel_fullscreen_n = {
                ...
                carousel_fullscreen_t = 'in-fullscreen-mode',
                carousel_fullscreen_l = () => {
                    let l;
                    function u(t) {
                        const u =
                            null == l ? void 0 : l.getOptions().Fullscreen;
                        let o = (
                            isPlainObject_t(u)
                                ? Object.assign(
                                      Object.assign({}, carousel_fullscreen_n),
                                      u
                                  )
                                : carousel_fullscreen_n
                        )[t];
                    ...
                    function o() {
                        var e;
                        null ===
                            (e = null == l ? void 0 : l.getPlugins().Toolbar) ||
                            void 0 === e ||
                            e.add('fullscreen', { tpl: u('btnTpl') });
                    }
                    function c() {
                        if (u('autoStart')) {
                            const e = s();
                    ...
                    function i(e, n) {
                        ...
                        t &&
                            !n.defaultPrevented &&
                            'toggle' === t.dataset.fullscreenAction &&
                            d();
                    }
                    function s() {
                        return (
                            u('el') ||
                            (null == l ? void 0 : l.getContainer()) ||
                            void 0
                        );
                    }
                    function r() {
                    ...
                    function a(e) {
                        ...
                        return (
                            ...
                            n.fullscreenEnabled
                                ? (l = e.requestFullscreen())
                                : n.webkitFullscreenEnabled &&
                                  (l = e.webkitRequestFullscreen(
                    ...
                    return {
                        ...
                        destroy: function () {
                            (null == l || l.off('initPlugins', o),
                                null == l || l.off('ready', c),
                                null == l || l.off('click', i));
                        },
                        exit: f,
                        inFullscreen: r,
                        request: a,
            ...
            const fancybox_hash_s = () => {
                    const t = new URL(document.URL).hash,
                        ...
                        o =
                            (n &&
                                ...
                                parseInt(e.pop() || '1', 10)) ||
                            1;
                    return { urlHash: t, urlSlug: e.join('-'), urlIndex: o };
                },
                fancybox_hash_a = () => {
                    const t =
                        null == fancybox_hash_e
                            ? void 0
                            : fancybox_hash_e.getInstance();
                ...
                fancybox_hash_u = () => {
                    ...
                    (o && fancybox_hash_e.fromTriggerEl(o),
                        fancybox_hash_a() ||
                            ...
                            o &&
                                fancybox_hash_e.fromTriggerEl(o, {
                                    startIndex: n - 1,
                                })),
                        fancybox_hash_a() &&
                            o &&
                ...
                fancybox_hash_c = () => {
                    ...
                    const t =
                            null == fancybox_hash_e
                                ? void 0
                                : fancybox_hash_e.getInstance(),
                        n = null == t ? void 0 : t.getCarousel();
                    if (!1 === (null == t ? void 0 : t.getOptions().Hash))
                        return;
                ...
                fancybox_hash_f = () => {
                            ...
                            e &&
                                e.goTo(
                                    ...
                                    void 0 === n
                                        ? void 0
                                        : n.getPageIndex()) || 0,
                                    { transition: !1, tween: !1 }
                                );
                        }
                        const u = t.getCarousel();
                        if (!u) return;
                        const { urlHash: d, urlSlug: f } = fancybox_hash_s(),
                            g = t.getSlide();
                        if (!g) return;
                        let h = g.slug || g.fancybox || '',
                            w = parseInt(g.index + '', 10) + 1;
                        if (!h) return;
                        let p = g.slug ? `#${g.slug}` : `#${h}-${w}`;
                        (((null ===
                            (l =
                                null === (i = t.getCarousel()) || void 0 === i
                                    ? void 0
                                    : i.getPages()) || void 0 === l
                            ? void 0
                            : l.length) || 0) < 2 && (p = `#${h}`),
                            ...
                            history.scrollRestoration &&
                                ((e = history.scrollRestoration),
                                (history.scrollRestoration = 'manual')),
                            u.on('change', c));
                        const y = h !== f;
                        try {
                            (window.history[y ? 'pushState' : 'replaceState'](
                                {},
                                document.title,
                    ...
                    return {
                        init: function (e) {
                            (clearTimeout(fancybox_hash_n),
                                (t = e),
                                t.on('ready', u),
                                t.on('close', d));
                        },
                        destroy: function () {
                            (null == t || t.off('ready', u),
                                null == t || t.off('close', d));
            ...
            ((fancybox_hash_f.startFromUrl = fancybox_hash_u),
                (fancybox_hash_f.setup = function (n) {
                    fancybox_hash_e ||
                        ((fancybox_hash_e = n),
                        canUseDOM_e() &&
            ...
            carousel_toolbar_r().add('close', { tpl: A });
            const fancybox_k = (e) => {
                e.cancelable && e.preventDefault();
            };
            const O = (e = null, t = '', n) => {
            ...
            const D = 'with-fancybox',
                B = () => {
                    ...
                    function te(e, ...t) {
                        const n = [...(ee.get(e) || [])];
                        for (const [t, o] of Object.entries($.on || {}))
                            (t === e || t.split(' ').indexOf(e) > -1) &&
                                n.push(o);
                        for (const e of n)
                            e && 'function' == typeof e && e(Oe, ...t);
                        '*' !== e && te('*', e, ...t);
                    }
                    function ne() {
                                ...
                                (function (e) {
                                    ...
                                    n.onreadystatechange = function () {
                                        if (
                                            ...
                                            if (
                                                (null == B || B.hideLoading(e),
                                                (e.state = 1),
                                                200 === n.status)
                                            ) {
                                                let o = n.responseText + '',
                                                    i = null,
                                                    s = null;
                                                if (e.filter) {
                                                    const t =
                                                ...
                                                (s && s instanceof HTMLElement
                                                    ...
                                                    (e.htmlEl = i),
                                                    t.classList.add('has-html'),
                                                    t.classList.add('has-ajax'),
                                                    t.prepend(i),
                                                    null == B ||
                                                        B.emit(
                                                            'contentReady',
                    ...
                    function ie(e, t) {
                        ...
                        (ye(t),
                            null === (n = t.el) ||
                                void 0 === n ||
                                n.removeEventListener('click', se),
                    ...
                    function se(e) {
                        if (!be()) return;
                        if (W !== _.Ready)
                            return (fancybox_k(e), void e.stopPropagation());
                        if (e.defaultPrevented) return;
                        if (!f.isClickAllowed()) return;
                    ...
                    function le() {
                        ((Y = !1),
                            T && B && T.classList.remove('is-revealing'),
                            de());
                        const e = J('sync');
                        if (B && e) {
                            const t = e.getPageIndex(B.getPageIndex()) || 0;
                            e.goTo(t, { transition: !1, tween: !1 });
                        }
                    }
                    function re() {
                        var e;
                    ...
                    function de() {
                        if (T) {
                            const e = (null == B ? void 0 : B.getPages()) || [],
                                t =
                                    (null == B ? void 0 : B.getPageIndex()) ||
                                    0;
                    ...
                    function fe(e) {
                        if (
                            !!e
                                .composedPath()[0]
                                .closest('[data-fancybox-close]')
                        )
                            return void Me(e);
                        if ((te('backdropClick', e), e.defaultPrevented))
                            return;
                    ...
                    function ve(e) {
                        ...
                        if (
                            ...
                            if (!l) {
                                ...
                                t &&
                                    (addClass_s(t, 'is-close-button'),
                                    (e.closeButtonEl = r.insertAdjacentElement(
                                        'afterbegin',
                                        t
                                    )),
                    ...
                    function ye(e) {
                        (e.closeButtonEl &&
                            ...
                            removeClass_s(e.el, 'has-close-btn'));
                    }
                    function he(e) {
                        if (
                            !(
                                ...
                                1 === B.getState() &&
                                e &&
                                e.index === B.getOptions().initialPage &&
                                e.el &&
                                e.el.parentElement
                            )
                        )
                        ...
                        Y = !1;
                        const t = e.panzoomRef,
                            n = null == t ? void 0 : t.getTween(),
                            o = J('zoomEffect') && n ? we(e) : void 0;
                        if (t && n && o) {
                            const {
                                x: e,
                                y: i,
                        ...
                        const i =
                            (null == t ? void 0 : t.getContent()) || e.htmlEl;
                        i && O(i, J('showClass', e));
                    }
                    function be() {
                        var e;
                        return (
                            (null === (e = N.getInstance()) || void 0 === e
                                ? void 0
                                : e.getId()) === K
                        );
                    }
                    ...
                    function we(e) {
                        ...
                        const i =
                            ...
                            s = null == i ? void 0 : i.width,
                            l = null == i ? void 0 : i.height;
                        if (!s || !l) return;
                        ...
                        if (Math.abs(s / l - a / c) > 0.1) return;
                        return {
                            x: u + 0.5 * a - (i.left + 0.5 * s),
                            y: d + 0.5 * c - (i.top + 0.5 * l),
                            scale: a / s,
                        };
                    }
                    function Le() {
                    ...
                    function Ce() {
                        (Le(),
                            null == T || T.classList.remove('is-idle'),
                            (G = !1));
                    }
                    function Te() {
                        const e = xe();
                    ...
                    function Me(e, t) {
                        ...
                        if ((te('shouldClose', a, e), a.defaultPrevented))
                            return;
                        if ((Le(), e)) {
                            if (e.defaultPrevented) return;
                            (fancybox_k(e),
                        ...
                        null === (r = null == c ? void 0 : c.Autoplay) ||
                            void 0 === r ||
                            r.stop();
                        const u = null == c ? void 0 : c.Fullscreen;
                        u && u.inFullscreen()
                            ? Promise.resolve(u.exit()).then(() => {
                                  setTimeout(() => {
                                      Ae(e, t);
                                  }, 150);
                              })
                    ...
                    function Ae(e, t) {
                        ...
                        (i && (null == r ? void 0 : r.contains(i)) && i.blur(),
                            J('fadeEffect') &&
                                (null == T || T.classList.remove('is-ready'),
                                null == T || T.classList.add('is-hiding')),
                            null == T || T.classList.add('is-closing'));
                        const s = Ee(),
                            l = null == s ? void 0 : s.el,
                            a = null == s ? void 0 : s.panzoomRef,
                            c =
                                null ===
                                    (n = null == s ? void 0 : s.panzoomRef) ||
                                void 0 === n
                                    ? void 0
                                    : n.getTween(),
                            u = t || J('hideClass');
                        ...
                        if (B && s && l && a && c) {
                            ...
                            if (
                                ...
                                (a.on('refresh', () => {
                                    ...
                                    c
                                        .easing(tween_c.Easings.EaseOut)
                                        .duration(350)
                                        .from(
                                            Object.assign({}, a.getTransform())
                                        )
                                        .to(
                                            Object.assign(
                                                Object.assign({}, y),
                        ...
                        const g =
                            (null == s ? void 0 : s.htmlEl) ||
                            (null === (o = null == s ? void 0 : s.panzoomRef) ||
                            void 0 === o
                                ? void 0
                                : o.getWrapper());
                        (g && R(g),
                    ...
                    function ke() {
                        ...
                        (te('destroy'),
                            null ===
                                (t =
                                    null === (e = J('sync')) || void 0 === e
                                        ? void 0
                                        : e.getPlugins().Autoplay) ||
                                void 0 === t ||
                                t.resume(),
                            null ===
                                (o =
                                    null === (n = J('sync')) || void 0 === n
                                        ? void 0
                                        : n.getPlugins().Autoscroll) ||
                                void 0 === o ||
                                o.resume(),
                            r instanceof HTMLDialogElement && r.close(),
                            null ===
                                (i = null == B ? void 0 : B.getContainer()) ||
                                void 0 === i ||
                                i.classList.remove('is-idle'),
                            null == B || B.destroy());
                        ...
                        if (
                            ...
                            try {
                                null == l || l.focus({ preventScroll: !0 });
                            } catch (e) {}
                    }
                    const Oe = {
                        close: Me,
                        ...
                        init: function (t = [], n = {}) {
                            ...
                            if (
                                ...
                                (function () {
                                    ...
                                    l && addClass_s(T, l);
                                    const a = J('mainStyle');
                                    if (a && isPlainObject_t(a))
                                        for (const [e, t] of Object.entries(a))
                                            T.style.setProperty(e, t);
                                    const u = J('theme'),
                                        d =
                                            'auto' === u
                                                ? window.matchMedia(
                                ...
                                (function () {
                                    ...
                                    ((B = carousel_E(M, e)),
                                        ...
                                        B.on('attachSlideEl', oe),
                                        B.on('detachSlideEl', ie),
                                        B.on('contentReady', ce),
                                        B.on('ready', re),
                                        B.on('change', le),
                                        B.on('settle', ae),
                                        B.on('thumbs:ready', ue),
                                        B.on('thumbs:destroy', ue),
                                        B.init());
                                })(),
                                r && T)
                            ) {
                                if (J('closeExisting'))
                                    for (const [e, t] of z.entries())
                                        e !== K && t.close();
                                (J('fadeEffect')
                                    ? (setTimeout(() => {
                                          ne();
                                      }, 500),
                                      addClass_s(T, 'is-revealing'))
                                    : ne(),
            ...
            function q(e, t = {}) {
                ...
                let s,
                    ...
                    c,
                    u = {};
                for (const [t, n] of N.openers)
                    if (t.contains(e))
                        for (const [o, i] of n) {
                            let n;
                            if (o) {
                                for (const i of t.querySelectorAll(o))
                                    if (i.contains(e)) {
                                        n = i;
                                        break;
                                    }
                ...
                if (!r || !c || !s) return;
                const d = extend_r({}, I, t, u, { triggerEl: s });
                let f = [].slice.call((a || r).querySelectorAll(c));
                const m = s.closest('.f-carousel'),
                    g = null == m ? void 0 : m.carousel;
                if (g && (!a || !m.contains(a))) {
                    const e = [];
                    for (const t of null == g ? void 0 : g.getSlides()) {
                        ...
                        n &&
                            (n.matches(c)
                                ? e.push(n)
                                : e.push(
                                      ...[].slice.call(n.querySelectorAll(c))
                                  ));
                    }
                    e.length &&
                        ((f = [...e]),
                        null === (n = g.getPlugins().Autoplay) ||
                            void 0 === n ||
                            n.pause(),
                        null === (o = g.getPlugins().Autoscroll) ||
                            void 0 === o ||
                            o.pause(),
                        (d.sync = g));
                }
                if (!1 === d.groupAll) {
                    const e = d.groupAttr,
                        t = e && s ? s.getAttribute(`${e}`) : '';
                    f =
                        e && t
                            ? f.filter((n) => n.getAttribute(`${e}`) === t)
                            : [s];
                }
                if (!f.length) return;
                null === (i = d.triggerEvent) ||
                    void 0 === i ||
                    i.preventDefault();
                ...
                return (
                    Object.assign({}, d.Carousel || {}).rtl &&
                        (f = f.reverse()),
                    s &&
                        void 0 === t.startIndex &&
                        (d.startIndex = f.indexOf(s)),
                    N.fromNodes(f, d)
                );
            }
            const N = {
                Plugins: { Hash: fancybox_hash_f },
                version: '6.1.7',
                openers: new Map(),
                bind: function (e, n, o, i) {
                    ...
                    (e instanceof Element && (s = e),
                        isString_t(e) && isString_t(n)
                            ? ((l = e), (a = n))
                            : isString_t(n) && isString_t(o)
                              ? ((l = n), (a = o))
                              : isString_t(n)
                                ? (a = n)
                                : isString_t(e) && (a = e),
                        ...
                        (function (e, t, n, o = {}) {
                            ...
                            const i = N.openers.get(e) || new Map(),
                                s = i.get(t) || new Map();
                            if (
                                (s.set(n, o),
                                i.set(t, s),
                                N.openers.set(e, i),
                                1 === i.size &&
                                    e.addEventListener('click', N.fromEvent),
                                1 === N.openers.size)
                            )
                                for (const e of Object.values(N.Plugins)) {
                                    const t = e.setup;
                ...
                fromEvent: function (e) {
                    ...
                    if (o) {
                        const e = o.dataset.fancyboxDelegate || '',
                            i = document.querySelectorAll(
                                `[data-fancybox="${e}"]`
                            ),
                            s =
                                parseInt(o.dataset.fancyboxIndex || '', 10) ||
                                0;
                        ((t = i[s] || i[0]),
                            extend_r(n, { delegateEl: o, startIndex: s }));
                    }
                    return q(t, n);
                },
                    ...
                    for (const i of e) {
                        const s = i.dataset || {},
                            ...
                            c =
                                ...
                                (null == r ? void 0 : r.getAttribute('src')) ||
                                (null == r ? void 0 : r.dataset.lazySrc) ||
                                void 0,
                            u = {
                                src: a,
                                alt:
                ...
                unbind: function (e, n, o) {
                    ...
                    (e instanceof Element && (i = e),
                        ...
                        (function (e, t, n) {
                            if (!(e && e instanceof Element && n)) return;
                            const o = N.openers.get(e) || new Map(),
                                i = o.get(t) || new Map();
                            (i && n && i.delete(n),
                                (i.size && n) || o.delete(t),
                                o.size ||
